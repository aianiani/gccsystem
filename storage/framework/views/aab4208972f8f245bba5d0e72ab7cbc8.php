<?php $__env->startSection('content'); ?>
    ...
    <div class="home-zoom">
        <div class="d-flex">
            ...
            <div class="main-dashboard-content flex-grow-1">
                <div class="main-dashboard-inner">
                    ...
                    <div class="details-header mb-4">
                        <div class="d-flex flex-column flex-md-row align-items-center gap-4 w-100">
                            ...
                            <!-- Student Info -->
                            <div class="flex-grow-1 text-center text-md-start" id="studentPrivacyContainer">

                                <h1 class="h3 fw-bold text-white mb-2"><?php echo e($studentName); ?></h1>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center gap-1">
                                        ...
                                        <span class="fw-semibold"><?php echo e($assessment->user->student_id ?? 'No ID'); ?></span>
                                    </div>
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="bi bi-envelope"></i>
                                        <span><?php echo e($assessment->user->email); ?></span>
                                    </div>
                                    <?php if($assessment->user->contact_number): ?>
                                        <div class="d-flex align-items-center gap-1">
                                            <i class="bi bi-telephone"></i>
                                            <span><?php echo e($assessment->user->contact_number); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div
                                    ...
                                    <?php if($assessment->user->college): ?>
                                        <div class="d-flex align-items-center gap-1">
                                            <i class="bi bi-building"></i> <?php echo e($assessment->user->college); ?>

                                        </div>
                                    <?php endif; ?>
                                    <?php if($assessment->user->course): ?>
                                        <div class="d-flex align-items-center gap-1">
                                            <i class="bi bi-mortarboard"></i> <?php echo e($assessment->user->course); ?>

                                        </div>
                                    <?php endif; ?>
                                    <?php if($assessment->user->year_level): ?>
                                        <div class="d-flex align-items-center gap-1">
                                            <i class="bi bi-calendar3"></i> <?php echo e($assessment->user->year_level); ?>
                                ...
                                <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-2">
                                    <span class="badge bg-white text-success border"><i
                                            class="bi bi-file-earmark-text me-1"></i> <?php echo e($assessment->type); ?></span>
                                    <span class="badge bg-white text-secondary border"><i class="bi bi-clock me-1"></i>
                                        <?php echo e($createdAt); ?></span>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($riskClass); ?> text-white border">
                                        <i class="bi bi-exclamation-triangle-fill me-1"></i> Risk: <?php echo e($riskLabel); ?>

                                    </span>
                                    <a href="<?php echo e(route('counselor.assessments.export', $assessment->id)); ?>" target="_blank"
                        ...
                        <div class="d-flex gap-2 align-self-md-start ms-md-auto">
                            <?php if(request('from_appointment')): ?>
                                <a href="<?php echo e(route('counselor.appointments.show', request('from_appointment'))); ?>"
                ...
                <div id="assessmentPrivacyContainer">
                    <?php if ($__env->exists('counselor.assessments.partials.summary', ['assessment' => $assessment])) echo $__env->make('counselor.assessments.partials.summary', ['assessment' => $assessment], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Mobile Sidebar Script (Privacy logic removed) -->
    <script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/counselor/assessments/show.blade.php ENDPATH**/ ?>