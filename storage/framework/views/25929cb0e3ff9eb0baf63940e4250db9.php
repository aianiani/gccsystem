    ...
    <div class="main-dashboard-inner home-zoom">
        ...
        <div class="page-header">
            <div class="header-content">
                ...
                <a href="<?php echo e(route('admin.resources.create')); ?>" class="btn-add">
        ...
        <div class="stats-row">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($resources->total()); ?></h3>
                    <p>Total Resources</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($resources->where('is_published', true)->count()); ?></h3>
                    <p>Published</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($resources->where('is_published', false)->count()); ?></h3>
                    <p>Drafts</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($resources->where('type', 'video')->count()); ?></h3>
                    <p>Videos</p>
                </div>
            </div>
        </div>
        ...
        <?php if($resources->count() > 0): ?>
            ...
            <div class="resources-grid" id="gridView">
                <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="resource-card" data-title="<?php echo e(strtolower($resource->title)); ?>"
                        data-category="<?php echo e($resource->category); ?>" data-type="<?php echo e($resource->type); ?>"
                        data-status="<?php echo e($resource->is_published ? 'published' : 'draft'); ?>">
                        <div class="card-thumbnail">
                            <span class="type-badge <?php echo e($resource->type); ?>"><?php echo e(ucfirst($resource->type)); ?></span>
                            <span
                                class="status-badge <?php echo e($resource->is_published ? 'published' : 'draft'); ?>"><?php echo e($resource->is_published ? 'Published' : 'Draft'); ?></span>
                            ...
                            <?php if($resource->type == 'video'): ?>
                                ...
                                <?php endif; ?>
                            <?php elseif($resource->type == 'image' && $resource->file_path): ?>
                                <img src="<?php echo e(asset('storage/' . $resource->file_path)); ?>"
                                    alt="<?php echo e($resource->title); ?>">
                        ...
                        <div class="card-content">
                            <div class="card-category"><?php echo e($resource->category); ?></div>
                            <h3 class="card-title"><?php echo e($resource->title); ?></h3>
                            <p class="card-description">
                                <?php echo e($resource->description ?? 'No description available.'); ?></p>

                            <div class="card-meta">
                                <span><i class="bi bi-calendar3"></i>
                                    <?php echo e($resource->created_at->format('M d, Y')); ?></span>
                                <?php if($resource->file_size): ?>
                                    <span><i class="bi bi-hdd"></i>
                                        <?php echo e(number_format($resource->file_size / (1024 * 1024), 1)); ?> MB</span>
                                <?php endif; ?>
                            </div>

                            <div class="card-actions">
                                <a href="<?php echo e($resource->file_path ? asset('storage/' . $resource->file_path) : $resource->content); ?>"
                                    target="_blank" class="btn-view">
                                    <i class="bi bi-eye"></i> View
                                </a>
                                <a href="<?php echo e(route('admin.resources.edit', $resource)); ?>" class="btn-edit">
                                    <i class="bi bi-pencil"></i> Edit
                                </a>
                                <form action="<?php echo e(route('admin.resources.destroy', $resource)); ?>" method="POST"
            ...
            <div class="resources-table-wrapper" id="tableView">
                <table class="resources-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-title="<?php echo e(strtolower($resource->title)); ?>"
                                data-category="<?php echo e($resource->category); ?>" data-type="<?php echo e($resource->type); ?>"
                                data-status="<?php echo e($resource->is_published ? 'published' : 'draft'); ?>">
                                <td>
                                    <div class="resource-info">
                                        <div class="resource-thumb">
                                            <?php if($resource->type == 'video'): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php elseif($resource->type == 'image' && $resource->file_path): ?>
                                                <img src="<?php echo e(asset('storage/' . $resource->file_path)); ?>" alt="">
                                            <?php elseif($resource->type == 'file'): ?>
                                        ...
                                        <div>
                                            <div class="resource-title"><?php echo e(Str::limit($resource->title, 40)); ?></div>
                                            <div class="resource-desc">
                                                <?php echo e(Str::limit($resource->description ?? 'No description', 50)); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td><span class="badge"
                                        style="background: var(--forest-green-lighter); color: var(--forest-green);"><?php echo e($resource->category); ?></span>
                                </td>
                                <td>
                                    <span class="badge <?php echo e($resource->type); ?>"
                                        style="background: <?php echo e($resource->type == 'video' ? '#e3f2fd' : ($resource->type == 'image' ? '#fff3e0' : ($resource->type == 'file' ? '#fce4ec' : '#e8f5e9'))); ?>; color: <?php echo e($resource->type == 'video' ? '#1565c0' : ($resource->type == 'image' ? '#e65100' : ($resource->type == 'file' ? '#c2185b' : '#2e7d32'))); ?>;">
                                        <i
                                            class="bi bi-<?php echo e($resource->type == 'video' ? 'play-circle' : ($resource->type == 'image' ? 'image' : ($resource->type == 'file' ? 'file-earmark' : 'link-45deg'))); ?> me-1"></i>
                                ...
                                <td>
                                    <span class="badge"
                                        style="background: <?php echo e($resource->is_published ? '#d4edda' : '#fff3cd'); ?>; color: <?php echo e($resource->is_published ? '#155724' : '#856404'); ?>;">
                                        <?php echo e($resource->is_published ? 'Published' : 'Draft'); ?>
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('admin.resources.create')); ?>" class="btn-create">
                    <i class="bi bi-plus-lg"></i>
                    Add First Resource
                </a>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/admin/resources/index.blade.php ENDPATH**/ ?>