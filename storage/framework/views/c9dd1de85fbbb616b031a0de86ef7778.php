...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="welcome-card" style="padding: 1rem 1.25rem; min-height: auto; border-radius: 12px;">
                        <div style="display: flex; align-items: center; gap: 0.75rem; flex: 1; min-width: 0;">
                            ...
                            <div style="min-width: 0;">
                                ...
                                <div style="font-size: 0.8rem; opacity: 0.75;"><?php echo e(now()->format('F j, Y')); ?></div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- FullCalendar CSS/JS -->
    <link href="<?php echo e(asset('vendor/fullcalendar/index.global.min.css')); ?>" rel="stylesheet">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/counselor/availability/index.blade.php ENDPATH**/ ?>