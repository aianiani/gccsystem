<?php $__env->startSection('content'); ?>
    ...
    <div class="dropdown me-3" style="position: fixed; top: 1.5rem; right: 2.5rem; z-index: 2000;">
        <button class="btn notification-bell position-relative p-0<?php echo e($unreadCount > 0 ? ' pulse' : ''); ?>" type="button" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $recentNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <li class="notification-item">
                    ...
                    <div class="notification-actions">
                        <?php if(isset($notification->data['appointment_id'])): ?>
                            <a href="<?php echo e(route('counselor.appointments.show', $notification->data['appointment_id'])); ?>" class="btn-view" title="View Details">
                                <i class="bi bi-eye"></i>
                            </a>
                        <?php endif; ?>
