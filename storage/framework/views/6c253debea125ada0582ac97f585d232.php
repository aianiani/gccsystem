            ...
            <div class="main-dashboard-content flex-grow-1" style="padding: 1rem;">
                <div class="welcome-card">
                    <div>
                        ...
                        <div class="welcome-text">Welcome back, <?php echo e(auth()->user()->first_name ?? auth()->user()->name); ?>!
                        </div>
                ...
                <div class="dashboard-layout">
                    <div class="dashboard-stats">
                        ...
                        <!-- Active Students -->
                        <div class="dashboard-stat-card">
                            <div class="stat-value"><?php echo e($activeStudentsCount); ?></div>
                ...
                <div class="calendar-section-grid">
                    ...
                    <div class="calendar-sidebar">
                        ...
                        <div class="agenda-list">
                            <?php $__empty_1 = true; $__currentLoopData = $todayAppointmentsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <div class="agenda-item"
                                                    style="border-left-color: <?php echo e($appt->status === 'pending' ? '#ffc107' :
                                ($appt->status === 'completed' ? '#1f7a2d' :
                                    ($appt->status === 'cancelled' || $appt->status === 'declined' ? '#dc3545' : '#28a745'))); ?>">
                                                    ...
                                                    <div class="agenda-status"
                                                        style="background: <?php echo e($appt->status === 'pending' ? '#fff9e6' :
                                ($appt->status === 'completed' ? '#eef6ee' :
                                    ($appt->status === 'cancelled' || $appt->status === 'declined' ? '#fbeeee' : '#eef6ee'))); ?>; color: <?php echo e($appt->status === 'pending' ? '#856404' :
                                ($appt->status === 'completed' ? '#1f7a2d' :
                                    ($appt->status === 'cancelled' || $appt->status === 'declined' ? '#721c24' : '#155724'))); ?>">
                                                        <?php echo e($appt->status === 'accepted' ? 'Approved' : ucfirst($appt->status)); ?>
                                    ...
                                    <?php $__currentLoopData = $allAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         ?>
                                        {
                                            ...
                                            extendedProps: {
                                                ...
                                                studentName: '<?php echo e(addslashes($appt->student ? $appt->student->name : "Unknown")); ?>',
                                                purpose: '<?php echo e(addslashes($appt->purpose)); ?>',
                                                riskLevel: '<?php echo e(($appt->student && $appt->student->assessments->first()) ? $appt->student->assessments->first()->risk_level : "low"); ?>',
                                                apptDate: '<?php echo e($appt->scheduled_at->format('M d, Y')); ?>',
                                                 apptTime: '<?php echo e($appt->scheduled_at->format('g:i a')); ?> - <?php echo e($appt->scheduled_at->copy()->addMinutes(90)->format('g:i a')); ?>'
                                            }
                                        },
                                                                            ...
                                                                            calendarTooltip.innerHTML = `
                                                                                ...
                                                                                <div class="main-content-card">
                                                                                    ...
                                                                                    <?php if($priorityStudents->count()): ?>
                                                                                        <?php $__currentLoopData = $priorityStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            ...
                                                                                            ?>
                                                                                            <div class="student-item <?php echo e(in_array($riskLevel, ['high', 'very-high']) ? 'high-risk' : ($riskLevel === 'moderate' ? 'moderate-risk' : '')); ?>">
                                                                                                <div class="d-flex justify-content-between align-items-center">
                                                                                                    ...
                                                                                                    <div class="d-flex align-items-center gap-2">
                                                                                                        <span class="badge-<?php echo e(in_array($riskLevel, ['high', 'very-high']) ? 'priority' : ($riskLevel === 'moderate' ? 'moderate' : 'normal')); ?>">
                                                                                                            <?php echo e(ucfirst(str_replace('-', ' ', $riskLevel))); ?> Risk
                                                                                                        </span>
                                                                                                        <a href="<?php echo e(route('counselor.students.show', $student->id)); ?>" class="btn-view btn-small">
                                                                                                            <i class="bi bi-eye"></i>
                                                                                                        </a>
                                                                                                    </div>
                                                                                                </div>
                                                                                ...
                                                                                <div class="main-content-card">
                                                                                    <div class="card-header">
                                                                                        ...
                                                                                        <a href="<?php echo e(route('announcements.index')); ?>" class="btn btn-light btn-sm">
                                                                                            <i class="bi bi-list-ul me-1"></i>View All
                                                                                        </a>
                                                                                    </div>
                                                                                    <div class="card-body">
                                                                                        <?php if($recentAnnouncements->count()): ?>
                                                                                            <?php $__currentLoopData = $recentAnnouncements->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                <div class="announcement-item mb-3 p-3" style="background: var(--gray-50); border-radius: 12px; border-left: 4px solid var(--forest-green);">
                                                                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                                                                        ...
                                                                                                        <small class="text-muted"><?php echo e($announcement->created_at->format('M d, Y')); ?></small>
                                                                                                    </div>
                                                                                                    <div class="mb-0 text-muted small">
                                                                                                        <?php echo Str::limit(strip_tags($announcement->content), 150); ?>
