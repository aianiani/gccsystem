...
<head>
    ...
    <title><?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name', 'GCC System')); ?></title>
    <style>
        body {
            margin: 0;
            padding: 0;
            ...
            <table class="main" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <td class="header">
                        <div class="header-inner">
                            <div class="header-logo">
                                <img src="<?php echo new \Illuminate\Support\EncodedHtmlString(asset('images/logo.jpg')); ?>" alt="CMU GCC Logo">
                            </div>
                    ...
                    <td class="body">
                        <div class="content-inner">
                            ...
                            <?php if(isset($subcopy)): ?>
                                <div class="subcopy">
                                    <?php echo Illuminate\Mail\Markdown::parse($subcopy); ?>
                ...
                <tr>
                    <td class="footer">
                        ...
                        <p style="margin: 0;">
                            &copy; <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> <?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name', 'GCC System')); ?>. All rights reserved.
                        </p>
                    </td>
                </tr>
            </table>
...
<?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/vendor/mail/html/message.blade.php ENDPATH**/ ?>