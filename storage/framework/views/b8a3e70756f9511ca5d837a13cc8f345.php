...
<head>
    ...
    <title><?php echo e(config('app.name', 'GCC System')); ?></title>

    <!-- Bootstrap CSS -->
    <link href="<?php echo e(asset('vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <!-- Bootstrap Icons -->
    <link href="<?php echo e(asset('vendor/bootstrap-icons/font/bootstrap-icons.css')); ?>" rel="stylesheet">
    <!-- FontAwesome -->
...
<body>
                    ...
                    <div class="custom-sidebar" id="adminSidebar" style="background: var(--sidebar-bg) !important;">
                        ...
                        <nav class="sidebar-nav flex-grow-1">
                            ...
                            <a href="<?php echo e(route('users.index')); ?>"
                                class="sidebar-link<?php echo e(request()->routeIs('users.*') ? ' active' : ''); ?>"><i
                                    class="bi bi-people"></i>Users</a>
                            <a href="<?php echo e(route('admin.registration-approvals.index')); ?>"
                                class="sidebar-link<?php echo e(request()->routeIs('admin.registration-approvals.*') ? ' active' : ''); ?>"><i
                            ...
                            <a href="<?php echo e(route('admin.hero-images.index')); ?>"
                                class="sidebar-link<?php echo e(request()->routeIs('admin.hero-images.*') ? ' active' : ''); ?>"><i
                                    class="bi bi-images"></i>Hero Images</a>
                            <a href="<?php echo e(route('admin.resources.index')); ?>"
                                class="sidebar-link<?php echo e(request()->routeIs('admin.resources.*') ? ' active' : ''); ?>"><i
                            ...
                            <a href="<?php echo e(route('activities')); ?>"
                                class="sidebar-link<?php echo e(request()->routeIs('activities') ? ' active' : ''); ?>"><i
                                    class="bi bi-activity"></i>Activity Logs</a>
                            <a href="<?php echo e(route('admin.reports.index')); ?>"
                                class="sidebar-link<?php echo e(request()->routeIs('admin.reports.*') ? ' active' : ''); ?>"><i
                                    class="bi bi-file-earmark-bar-graph"></i>Reports</a>
                            <a href="<?php echo e(route('admin.analytics.index')); ?>"
                                class="sidebar-link<?php echo e(request()->routeIs('admin.analytics.*') ? ' active' : ''); ?>"><i
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            <?php if(request()->routeIs('2fa.form')): ?>
...
</html><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/layouts/app.blade.php ENDPATH**/ ?>