        ...
        <div class="d-flex">
            ...
            <div class="custom-sidebar">
                ...
                <div class="sidebar-bottom w-100">
                    ...
                    <form id="logout-form-index" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
                    </form>
                </div>
            </div>
                    ...
                    <div class="container-fluid px-4 py-4">
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                <form
                                                                    ...
                                                                    <button type="submit" class="btn btn-success btn-sm py-1 px-3"
                                                                        style="font-size: 0.8rem;">Accept</button>
                                                                </form>
                                                                <form
                        ...
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <a href="<?php echo e(route('appointments.create')); ?>" class="btn-book-new px-4 py-2">
                                    Start Your Journey
                                </a>
                            </div>
                        <?php endif; ?>
