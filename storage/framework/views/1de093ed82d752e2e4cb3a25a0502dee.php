                            ...
                            <div class="col-12 col-md-4">
                                <div class="dashboard-stat-card">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-value"><?php echo e(number_format($totalAppointments)); ?></div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="dashboard-stat-card">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-value"><?php echo e(number_format($pendingAppointments)); ?></div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="dashboard-stat-card">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-value"><?php echo e(number_format($completedAppointments)); ?></div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0" id="search" name="search" value="<?php echo e(request('search')); ?>" placeholder="Name, Email, or Student ID">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select form-select-sm" id="status" name="status">
                                            ...
                                            <option value="rescheduled_pending" <?php echo e(request('status') == 'rescheduled_pending' ? 'selected' : ''); ?>>Reschedule Pending</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select form-select-sm" id="nature_of_problem" name="nature_of_problem">
                                            ...
                                            <option value="Academic" <?php echo e(request('nature_of_problem') == 'Academic' ? 'selected' : ''); ?>>Academic</option>
                                            <option value="Personal" <?php echo e(request('nature_of_problem') == 'Personal' ? 'selected' : ''); ?>>Personal</option>
                                            <option value="Social" <?php echo e(request('nature_of_problem') == 'Social' ? 'selected' : ''); ?>>Social</option>
                                            <option value="Family" <?php echo e(request('nature_of_problem') == 'Family' ? 'selected' : ''); ?>>Family</option>
                                            <option value="Career" <?php echo e(request('nature_of_problem') == 'Career' ? 'selected' : ''); ?>>Career</option>
                                            <option value="Mental Health" <?php echo e(request('nature_of_problem') == 'Mental Health' ? 'selected' : ''); ?>>Mental Health</option>
                                            <option value="Other" <?php echo e(request('nature_of_problem') == 'Other' ? 'selected' : ''); ?>>Other</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select form-select-sm" id="sort_by" name="sort_by">
                                            <option value="date_desc" <?php echo e(request('sort_by') == 'date_desc' ? 'selected' : ''); ?>>Newest</option>
                                            <option value="date_asc" <?php echo e(request('sort_by') == 'date_asc' ? 'selected' : ''); ?>>Oldest</option>
                                    ...
                                    <div class="col-md-2 d-flex align-items-end gap-2">
                                        ...
                                        <a href="<?php echo e(route('counselor.appointments.index')); ?>" class="btn btn-outline-secondary btn-sm" title="Clear Filters">
                                ...
                                <?php if($completedAppointments > 0): ?>
                                    <div class="mt-3 text-end">
                                        <button type="button" id="deleteAllCompletedBtn" class="btn btn-outline-danger btn-sm py-1">
                                            <i class="bi bi-trash3-fill me-1"></i>Clear Completed Sessions (<?php echo e($completedAppointments); ?>)
                                        </button>
                                    </div>
                                <?php endif; ?>
                            </form>
                        ...
                        <div class="main-content-card">
                            <div class="card-header">
                                <h5 class="mb-0"><i class="bi bi-calendar-range me-2"></i>Appointments List
                                    (<?php echo e($appointments->total()); ?>)</h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row align-items-center gy-3">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-5">
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="<?php echo e($appointment->student->avatar_url); ?>"
                                                        alt="<?php echo e($appointment->student->name); ?>"
                                                    ...
                                                    <div class="overflow-hidden flex-grow-1">
                                                        <div class="d-flex align-items-center gap-2 mb-1">
                                                            <h6 class="mb-0 fw-bold text-truncate"
                                                                ...
                                                                <?php echo e($appointment->student->name); ?>

                                                            </h6>
                                                            <span class="badge bg-info text-dark px-2 py-1"
                                                                style="font-size: 0.7rem;">
                                                                <i class="bi bi-hash"></i><?php echo e($appointment->session_number); ?>
                                                        ...
                                                        <div class="d-flex flex-column small text-muted"
                                                            ...
                                                            <span class="text-truncate"><i
                                                                    class="bi bi-building me-1"></i><?php echo e($appointment->student->college ?? 'N/A'); ?></span>
                                                            <span class="text-truncate"><i
                                                                    class="bi bi-gender-ambiguous me-1"></i><?php echo e(ucfirst($appointment->student->sex ?? 'N/A')); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-2">
                                                <div class="d-none d-md-block border-start border-end px-3 text-center">
                                                    <div class="fw-bold" style="font-size: 1.05rem; color: var(--text-dark);">
                                                        <?php echo e($appointment->scheduled_at->format('M d, Y')); ?>

                                                    </div>
                                                    <div class="text-secondary fw-semibold" style="font-size: 0.9rem;">
                                                        <?php echo e($appointment->scheduled_at->format('g:i A')); ?>

                                                    </div>
                                                    <small class="text-muted"
                                                        style="font-size: 0.75rem;"><?php echo e($appointment->scheduled_at->diffForHumans()); ?></small>
                                                </div>
                                                <!-- Mobile view -->
                                                <div class="d-md-none text-muted small mb-2">
                                                    <i
                                                        class="bi bi-calendar-event me-1"></i><?php echo e($appointment->scheduled_at->format('M d, Y • g:i A')); ?>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3 text-start text-md-center">
                                                ...
                                                ?>
                                                <span
                                                    class="badge <?php echo e($statusMap[$status]['class'] ?? 'bg-secondary'); ?> px-3 py-2 mb-2 rounded-pill d-inline-flex align-items-center"
                                                    style="font-size: 0.85rem;">
                                                    <i class="bi bi-<?php echo e($statusMap[$status]['icon'] ?? 'info-circle'); ?> me-1"></i>
                                                    <?php echo e($status === 'accepted' ? 'Approved' : ucfirst(str_replace('_', ' ', $status))); ?>

                                                </span>
                                                <div class="small text-muted fst-italic text-truncate px-2 mx-auto"
                                                    style="max-width: 200px; font-size: 0.8rem;">
                                                    <?php echo e($appointment->nature_of_problem ?? 'No topic specified'); ?>
                                ...
                                <?php if($appointments->hasPages()): ?>
                                    <div class="d-flex justify-content-center mt-4">
                                        <?php echo e($appointments->links('vendor.pagination.bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/counselor/appointments/index.blade.php ENDPATH**/ ?>