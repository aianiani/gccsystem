                            ...
                            <div class="row g-2 mb-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-select" id="sort_by" name="sort_by">
                                        <option value="date_desc" <?php echo e(request('sort_by') == 'date_desc' ? 'selected' : ''); ?>>
                                            Date: Newest First</option>
                                        <option value="date_asc" <?php echo e(request('sort_by') == 'date_asc' ? 'selected' : ''); ?>>
                            ...
                            <div class="row g-2 align-items-end">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select form-select-sm" id="nature_of_problem"
                                        ...
                                        <option value="Other" <?php echo e(request('nature_of_problem') == 'Other' ? 'selected' : ''); ?>>
                                            Other</option>
                                    </select>
                                </div>
                                <div class="col-md-9">
                                    <div class="d-flex gap-2">
                                        ...
                                        <?php if($completedAppointments > 0): ?>
                                            <button id="deleteAllCompletedBtn" class="btn btn-danger btn-sm">
                                                ...
                                                (<?php echo e($completedAppointments); ?>)
                                            </button>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    ...
                                                    <div class="d-flex flex-column small text-muted"
                                                        ...
                                                        <span class="text-truncate"><i
                                                                class="bi bi-gender-ambiguous me-1"></i><?php echo e(ucfirst($appointment->student->gender ?? 'N/A')); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
