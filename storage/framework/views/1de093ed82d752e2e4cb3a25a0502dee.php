                ...
                <div class="main-dashboard-inner">
                    ...
                    <?php if(session('error')): ?>
                        <div class="alert alert-danger border-0 shadow-sm rounded-3 mb-3 d-flex align-items-center py-2">
                            ...
                            <span class="fw-medium"><?php echo e(session('error')); ?></span>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="stats-row">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                <h3><?php echo e(number_format($completedAppointments)); ?></h3>
                                <p>Completed</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Filter Bar -->
                    <form method="GET" action="<?php echo e(route('counselor.appointments.index')); ?>" class="filter-bar">
                        <div class="filter-row">
                            ...
                            <select name="status" class="filter-select">
                                ...
                                <option value="accepted" <?php echo e(request('status') == 'accepted' ? 'selected' : ''); ?>>Approved
                                </option>
                                <option value="completed" <?php echo e(request('status') == 'completed' ? 'selected' : ''); ?>>Completed
                                </option>
                                <option value="rescheduled_pending" <?php echo e(request('status') == 'rescheduled_pending' ? 'selected' : ''); ?>>Rescheduled</option>
                                <option value="declined" <?php echo e(request('status') == 'declined' ? 'selected' : ''); ?>>Declined
                                </option>
                            </select>

                            <select name="sort_by" class="filter-select">
                                <option value="date_desc" <?php echo e(request('sort_by') == 'date_desc' ? 'selected' : ''); ?>>Newest
                                    First</option>
                                <option value="date_asc" <?php echo e(request('sort_by') == 'date_asc' ? 'selected' : ''); ?>>Oldest First
                                </option>
                            ...
                            <a href="<?php echo e(route('counselor.appointments.index')); ?>" class="btn-reset" title="Reset">
                    ...
                    <div class="content-card">
                        ...
                        <form id="bulk-approve-form" action="<?php echo e(route('counselor.appointments.bulkApprove')); ?>"
                            method="POST" class="d-none"><?php echo csrf_field(); ?></form>
                        <form id="bulk-delete-form" action="<?php echo e(route('counselor.appointments.bulkDestroy')); ?>" method="POST"
                            class="d-none"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?></form>
                        ...
                        <?php if($appointments->count() > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="student-cell">
                                                        <img src="<?php echo e($appointment->student->avatar_url); ?>" alt=""
                                                            class="student-avatar">
                                                        <div class="student-info">
                                                            <h6><?php echo e($appointment->student->name); ?></h6>
                                                            <span><?php echo e($appointment->student->student_id ?? '-'); ?> •
                                                                <?php echo e($appointment->student->college ?? ''); ?></span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <span class="status-badge <?php echo e($statusClasses[$status] ?? 'status-pending'); ?>">
                                                ...
                                                <td>
                                                    <span
                                                        class="nature-badge"><?php echo e($appointment->nature_of_problem ?? 'Unspecified'); ?></span>
                                                </td>
                                                <td>
                                                    <div class="actions-cell">
                                                        ...
                                                        <?php if($appointment->status === 'pending' || $appointment->status === 'rescheduled_pending'): ?>
                                                            <form
                                                        ...
                                                        <button type="button" class="btn-action delete" title="Delete"
                                                            onclick="confirmDelete(<?php echo e($appointment->id); ?>)">
                                                            <i class="bi bi-trash3-fill"></i>
                                                        </button>
                                                        <form id="delete-form-<?php echo e($appointment->id); ?>"
                                                            action="<?php echo e(route('counselor.appointments.destroy', $appointment->id)); ?>"
                            ...
                            <div class="pagination-wrap">
                                <?php echo e($appointments->links('vendor.pagination.premium')); ?>
                ...
                bulkApproveBtn.addEventListener('click', () => {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            bulkApproveForm.innerHTML = '<?php echo csrf_field(); ?>';
                            ids.forEach(id => {
            ...
            if (bulkSmsBtn) {
                bulkSmsBtn.addEventListener('click', () => {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch('<?php echo e(route("counselor.appointments.bulkSmsPrepare")); ?>', {
                                method: 'POST',
                                headers: {
                ...
                bulkNotifyBtn.addEventListener('click', () => {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.method = 'POST';
                            form.action = '<?php echo e(route("counselor.appointments.bulkReminder")); ?>';
