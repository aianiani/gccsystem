    ...
    <nav class="sidebar-nav">
        ...
        <div class="sidebar-resources">
            ...
            <a href="<?php echo e(route('resources')); ?>"
                class="sidebar-link<?php echo e(request()->routeIs('resources') ? ' active' : ''); ?>"><i
...
</script><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/student/sidebar.blade.php ENDPATH**/ ?>