        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="main-content-card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.hero-images.update', $heroImage->id)); ?>" method="POST"
                            ...
                            <div class="row mb-4">
                                <div class="col-md-5">
                                    ...
                                    <div class="ratio ratio-16x9 rounded overflow-hidden shadow-sm border">
                                        <img src="<?php echo e(asset($heroImage->image_path)); ?>" alt="Current Image"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    value="<?php echo e($heroImage->title); ?>">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control" id="order" name="order"
                                        value="<?php echo e($heroImage->order); ?>" min="0">
                                </div>
                                <div class="col-md-6 mb-4 d-flex align-items-center">
                                    <div class="form-check p-0 ms-3 mt-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                                value="1" <?php echo e($heroImage->is_active ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/admin/hero_images/edit.blade.php ENDPATH**/ ?>