<div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 py-1">
    <div class="text-muted small">
        <?php if($paginator->total() > 0): ?>
            Showing <span class="fw-bold text-dark"><?php echo e($paginator->firstItem()); ?></span> to <span
                class="fw-bold text-dark"><?php echo e($paginator->lastItem()); ?></span> of <span
                class="fw-bold"><?php echo e($paginator->total()); ?></span> results
        <?php else: ?>
            <?php echo e($paginator->total()); ?> results
        <?php endif; ?>
    </div>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/vendor/pagination/premium.blade.php ENDPATH**/ ?>