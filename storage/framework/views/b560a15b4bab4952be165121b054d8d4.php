...
<?php $__env->startSection('content'); ?>
    ...
    <div class="main-dashboard-inner home-zoom">
        ...
        <div class="page-header">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('users.index')); ?>" class="btn btn-outline-secondary btn-sm fw-semibold shadow-sm">
                    <i class="bi bi-people me-2"></i>All Users
                </a>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-secondary btn-sm fw-semibold shadow-sm">
        ...
        <div class="stats-row">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($pendingRegistrations->total()); ?></h3>
                    <p>Pending Review</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($approvedRegistrations->total()); ?></h3>
                    <p>Approved Today</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($rejectedRegistrations->total()); ?></h3>
                    <p>Rejected</p>
                </div>
            </div>
        </div>
        ...
        <div class="filter-bar">
            <form action="<?php echo e(route('admin.registration-approvals.index')); ?>" method="GET">
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="filter-label"><i class="bi bi-search me-1"></i> Search</label>
                        <input type="text" class="filter-input" name="search" value="<?php echo e(request('search')); ?>"
                    ...
                    <div class="col-md-8 d-flex align-items-end justify-content-end">
                        <?php if(request()->anyFilled(['search', 'college', 'course', 'sort', 'date_from', 'date_to'])): ?>
                            <a href="<?php echo e(route('admin.registration-approvals.index')); ?>" class="btn btn-danger btn-sm px-3"
        ...
        <ul class="nav nav-pills mb-4" id="approvalTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending"
                    ...
                    <i class="bi bi-clock me-2"></i>Pending (<?php echo e($pendingRegistrations->total()); ?>)
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="approved-tab" data-bs-toggle="tab" data-bs-target="#approved" type="button"
                    role="tab">
                    <i class="bi bi-check-circle me-2"></i>Approved (<?php echo e($approvedRegistrations->total()); ?>)
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="rejected-tab" data-bs-toggle="tab" data-bs-target="#rejected" type="button"
                    role="tab">
                    <i class="bi bi-x-circle me-2"></i>Rejected (<?php echo e($rejectedRegistrations->total()); ?>)
                </button>
            </li>
        </ul>
        ...
        <div class="tab-content" id="approvalTabsContent">
            ...
            <div class="tab-pane fade show active" id="pending" role="tabpanel">
                    ...
                    <?php if($pendingRegistrations->count() > 0): ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 px-2">
                            ...
                            <div class="text-muted small">
                                Showing <?php echo e($pendingRegistrations->firstItem()); ?>-<?php echo e($pendingRegistrations->lastItem()); ?> of
                                <?php echo e($pendingRegistrations->total()); ?>

                            </div>
                        </div>

                        <?php $__currentLoopData = $pendingRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="d-flex align-items-center gap-4 flex-grow-1">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <?php else: ?>
                                                <div class="rounded-circle bg-light d-flex align-items-center justify-content-center shadow-sm"
                                                    ...
                                                    <span
                                                        class="fw-bold text-success"><?php echo e(strtoupper(substr($user->name ?? 'U', 0, 1))); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                                                <h6 class="mb-0 fw-bold text-dark fs-6"><?php echo e($user->name ?? 'N/A'); ?></h6>
                                                <small class="text-muted"><i
                                                        class="bi bi-clock me-1"></i><?php echo e($user->created_at->format('M d, h:i A')); ?></small>
                                            </div>
                                            <div class="mb-1 text-muted small">
                                                <?php echo e($user->email ?? 'N/A'); ?>

                                                <?php if($user->has_potential_duplicate ?? false): ?>
                                                    <span class="badge bg-warning text-dark border border-warning ms-2"
                                                        title="Potential duplicate: <?php echo e($user->duplicate_count); ?> similar record(s) found">
                                                        <i class="bi bi-exclamation-triangle"></i>
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                            <div class="text-muted small">
                                                <span class="fw-medium text-dark"><?php echo e($user->student_id ?? 'N/A'); ?></span>
                                                <span class="mx-2 text-muted">&bull;</span>
                                                <span class="text-truncate" style="max-width: 200px;"
                                                    title="<?php echo e($user->course); ?>"><?php echo e($user->course ?? 'N/A'); ?></span>
                                                <span class="mx-2 text-muted">&bull;</span>
                                                <span class="text-truncate" style="max-width: 200px;"
                                                    title="<?php echo e($user->college); ?>"><?php echo e($user->college ?? 'N/A'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 border-start ps-4">
                                        ...
                                        <?php if($user->cor_file): ?>
                                            <button type="button" class="btn btn-light btn-sm text-danger border" data-bs-toggle="modal"
                                                data-bs-target="#corPreviewModal<?php echo e($user->id); ?>" title="View COR File">
                                        ...
                                        <a href="<?php echo e(route('admin.registration-approvals.show', $user->id)); ?>"
                                        ...
                                        <button type="button" class="btn btn-success btn-sm rounded-pill px-3"
                                            onclick="confirmAction('<?php echo e(route('admin.registration-approvals.approve', $user->id)); ?>', 'Approve <?php echo e(addslashes($user->name)); ?>?')">
                                            <i class="bi bi-check-lg"></i>
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm rounded-pill px-3"
                                            onclick="confirmRejectAction('<?php echo e(route('admin.registration-approvals.reject', $user->id)); ?>', 'Reject <?php echo e(addslashes($user->name)); ?>?')">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            ...
                            <div>
                                <?php echo e($pendingRegistrations->withQueryString()->links('vendor.pagination.premium-simple')); ?>
                ...
                <?php $__currentLoopData = $pendingRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($user->cor_file): ?>
                        <div class="modal fade" id="corPreviewModal<?php echo e($user->id); ?>" tabindex="-1">
                                    ...
                                    <div class="modal-body p-0">
                                        ...
                                        <?php if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                                            <div class="p-3 text-center bg-light">
                                                <img src="<?php echo e(asset('storage/cor_files/' . $user->cor_file)); ?>"
                                                    class="img-fluid rounded shadow-sm" style="max-height: 70vh; object-fit: contain;"
                                                    alt="COR File">
                                            </div>
                                        <?php else: ?>
                                            <iframe src="<?php echo e(asset('storage/cor_files/' . $user->cor_file)); ?>"
            ...
            <div class="tab-pane fade" id="approved" role="tabpanel">
                <?php if($approvedRegistrations->count() > 0): ?>
                    <div class="d-flex justify-content-between align-items-center mb-3 px-2">
                        <div class="text-muted small">
                            Showing <?php echo e($approvedRegistrations->firstItem()); ?>-<?php echo e($approvedRegistrations->lastItem()); ?> of
                            <?php echo e($approvedRegistrations->total()); ?>

                        </div>
                    </div>


                    <?php $__currentLoopData = $approvedRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="registration-item p-4">
                            <div class="d-flex align-items-center gap-4">
                                <!-- Avatar -->
                                <div class="position-relative">
                                    <?php if($user->avatar): ?>
                                        <img src="<?php echo e($user->avatar_url); ?>" alt="<?php echo e($user->name); ?>" class="rounded-circle shadow-sm"
                                            style="width: 48px; height: 48px; object-fit: cover;">
                                    <?php else: ?>
                                        <div class="rounded-circle bg-light d-flex align-items-center justify-content-center shadow-sm"
                                            style="width: 48px; height: 48px;">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        ...
                                        <small class="text-muted"><i
                                                class="bi bi-calendar-check me-1"></i><?php echo e($user->approved_at ? $user->approved_at->format('M d, h:i A') : 'N/A'); ?></small>
                                    </div>
                                    <div class="mb-1 text-muted small">
                                        <?php echo e($user->email ?? 'N/A'); ?>
                                    ...
                                    <div class="text-muted small">
                                        <?php if($user->approvedBy): ?>
                                            <span class="text-muted">Approved by <?php echo e($user->approvedBy->name); ?></span>
                                        <?php endif; ?>
                                        <?php if($user->registration_notes): ?>
                                            <span class="border-start ps-3 ms-3 text-truncate d-inline-block align-bottom"
                                                style="max-width: 300px;" title="<?php echo e($user->registration_notes); ?>">
                                                <i class="bi bi-sticky me-1"></i><?php echo e($user->registration_notes); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <div>
                            <?php echo e($approvedRegistrations->withQueryString()->links('vendor.pagination.premium-simple')); ?>
            ...
            <div class="tab-pane fade" id="rejected" role="tabpanel">
                <?php if($rejectedRegistrations->count() > 0): ?>
                    <div class="d-flex justify-content-between align-items-center mb-3 px-2">
                        <div class="text-muted small">
                            Showing <?php echo e($rejectedRegistrations->firstItem()); ?>-<?php echo e($rejectedRegistrations->lastItem()); ?> of
                            <?php echo e($rejectedRegistrations->total()); ?>

                        </div>
                    </div>


                    <?php $__currentLoopData = $rejectedRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="registration-item p-4">
                            <div class="d-flex align-items-center gap-4">
                                <!-- Avatar -->
                                <div class="position-relative">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        ...
                                        <small class="text-muted"><i
                                                class="bi bi-calendar-x me-1"></i><?php echo e($user->approved_at ? $user->approved_at->format('M d, h:i A') : 'N/A'); ?></small>
                                    </div>
                                    <div class="mb-1 text-muted small">
                                        <?php echo e($user->email ?? 'N/A'); ?>
                                    ...
                                    <div class="text-muted small">
                                        <?php if($user->approvedBy): ?>
                                            <span class="text-muted">Rejected by <?php echo e($user->approvedBy->name); ?></span>
                                        <?php endif; ?>
                                        <?php if($user->rejection_reason): ?>
                                            <span class="border-start ps-3 ms-3 text-danger text-truncate d-inline-block align-bottom"
                                                style="max-width: 300px;" title="<?php echo e($user->rejection_reason); ?>">
                                                <i class="bi bi-exclamation-circle me-1"></i><?php echo e($user->rejection_reason); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <div>
                            <?php echo e($rejectedRegistrations->withQueryString()->links('vendor.pagination.premium-simple')); ?>
    ...
    <script>
            ...
            if (action === 'approve') {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        form.action = "<?php echo e(route('admin.registration-approvals.bulk-approve')); ?>";
                        form.submit();
                    }
                });
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed && result.value) {
                        ...
                        form.action = "<?php echo e(route('admin.registration-approvals.bulk-reject')); ?>";
                        form.submit();
                    }
                });
            }
        ...
        window.verifyEnrollment = async function (btn) {
            ...
            try {
                const response = await fetch('<?php echo e(route("admin.registration-approvals.verify-enrollment")); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/admin/registration-approvals/index.blade.php ENDPATH**/ ?>