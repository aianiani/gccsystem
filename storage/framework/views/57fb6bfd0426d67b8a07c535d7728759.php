<?php $__env->startSection('content'); ?>
    <style>
        ...
        <?php elseif(auth()->check() && auth()->user()->isCounselor()): ?>
                        ...
                        <div class="main-content-card">
                            <div class="card-header">
                                ...
                                <?php if(auth()->check() && method_exists(auth()->user(), 'isAdmin') && auth()->user()->isAdmin()): ?>
                                    <a href="<?php echo e(route('announcements.create')); ?>" class="btn btn-outline-success btn-sm">
                            ...
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <div class="row g-4">
    <?php elseif(auth()->check() && auth()->user()->isAdmin()): ?>
                                    <div class="main-dashboard-inner home-zoom">
                                        <div class="page-header-card">
                                            ...
                                            <div>
                                                <a href="<?php echo e(route('announcements.create')); ?>" class="btn btn-light btn-lg">
                                                                ...
                                                                <div class="col-md-6 col-lg-4">
                                                                    <a href="<?php echo e(route('announcements.show', $announcement->id)); ?>"
                                                                        ...
                                                                        <p class="announcement-excerpt">
                                                                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($announcement->content ?? ''), 140)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/announcements/index.blade.php ENDPATH**/ ?>