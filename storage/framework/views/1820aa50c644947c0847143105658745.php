                            ...
                            <div class="row g-3 pt-2">
                                <div class="col-md-2">
                                    ...
                                    <select class="filter-select" name="year_level" onchange="this.form.submit()">
                                        ...
                                        <option value="1st Year" <?php echo e(request('year_level') === '1st Year' ? 'selected' : ''); ?>>
                                            1st
                                            Year</option>
                                        <option value="2nd Year" <?php echo e(request('year_level') === '2nd Year' ? 'selected' : ''); ?>>
                                            2nd
                                            Year</option>
                                        <option value="3rd Year" <?php echo e(request('year_level') === '3rd Year' ? 'selected' : ''); ?>>
                                            3rd
                                            Year</option>
                                        <option value="4th Year" <?php echo e(request('year_level') === '4th Year' ? 'selected' : ''); ?>>
                                            4th
                                            Year</option>
