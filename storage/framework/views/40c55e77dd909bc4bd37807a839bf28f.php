    ...
    <div class="nav-notification-container dropdown">
        <button class="nav-notification-btn" id="navNotificationBtn" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <?php if($unreadCount > 0): ?>
                <span class="notification-bell-badge nav-notification-badge"><?php echo e($unreadCount); ?></span>
            <?php endif; ?>
        </button>
        <ul class="dropdown-menu dropdown-menu-end modern-dropdown-menu notification-dropdown-menu" id="notificationMenu" style="width: 350px;">
            <li class="notification-dropdown-header">
                ...
                <span class="badge bg-primary rounded-pill" style="font-size: 0.7rem;"><?php echo e($unreadCount); ?> New</span>
            </li>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="notification-item" style="border: none; border-radius: 0; padding: 0.85rem 1rem;">
                        ...
                        <div class="notification-content">
                            <div style="font-size: 0.85rem; color: #334155;"><?php echo e($notification->data['message'] ?? 'New notification'); ?></div>
                            <div class="text-muted" style="font-size: 0.7rem; margin-top: 2px;"><?php echo e($notification->created_at->diffForHumans()); ?></div>
                        </div>
                        <div class="notification-actions">
                             <button type="button" class="btn btn-link dismiss-notification p-0" data-id="<?php echo e($notification->id); ?>" style="color: #cbd5e1;">
                                <i class="bi bi-x"></i>
                            </button>
                        </div>
                    </li>
    ...
    <div class="dropdown">
        <div class="counselor-profile-wrapper dropdown-toggle" id="counselorProfileDropdownModern" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="counselor-info-text text-end">
                <span class="counselor-name-top"><?php echo e(auth()->user()->name); ?></span>
                <span class="counselor-status-top">Online</span>
            </div>
            <img src="<?php echo e(auth()->user()->avatar_url ?? asset('images/default-avatar.png')); ?>" alt="Profile" class="counselor-profile-img">
        </div>
        <ul class="dropdown-menu dropdown-menu-end modern-dropdown-menu" aria-labelledby="counselorProfileDropdownModern">
            <div class="dropdown-user-header">
                <span class="u-name"><?php echo e(auth()->user()->name); ?></span>
                <span class="u-email"><?php echo e(auth()->user()->email); ?></span>
            </div>
            <li>
                <a class="modern-dropdown-item" href="<?php echo e(route('profile')); ?>">
                    <i class="bi bi-person"></i> My Profile
                </a>
            </li>
            <li>
                <a class="modern-dropdown-item" href="<?php echo e(route('counselor.availability.index')); ?>">
...
<?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/partials/counselor_navbar.blade.php ENDPATH**/ ?>