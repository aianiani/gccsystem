                ...
                <div class="container py-1">
                    ...
                    <div class="assessment-cards-row" id="assessment-cards">
                        ...
                        <div class="assessment-card <?php echo e($userYear !== 1 ? 'locked' : ''); ?>">
                            ...
                            <?php elseif(isset($completed_assessments) && in_array('GRIT Scale', $completed_assessments)): ?>
                            ...
                            <button class="assessment-btn" <?php echo e($userYear !== 1 ? 'disabled' : ''); ?>
                                ...
                                onclick="openAssessment('grit')"><?php echo e($userYear !== 1 ? 'LOCKED' : ((isset($completed_assessments) && in_array('GRIT Scale', $completed_assessments)) ? 'RETAKE TEST' : 'START GRIT TEST')); ?></button>
                        </div>
                        ...
                        <div class="assessment-card <?php echo e($userYear !== 2 ? 'locked' : ''); ?>">
                            ...
                            <?php elseif(isset($completed_assessments) && in_array('DASS-42', $completed_assessments)): ?>
                                <div class="position-absolute" style="top: 10px; left: 10px; color: var(--forest-green);">
                                    <i class="bi bi-check-circle-fill fs-5" title="Completed" data-bs-toggle="tooltip"></i>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($userYear === 2): ?>
                                <a href="<?php echo e(route('assessments.dass42')); ?>"
                                    class="assessment-btn text-decoration-none text-center"><?php echo e((isset($completed_assessments) && in_array('DASS-42', $completed_assessments)) ? 'RETAKE DASS-42' : 'START DASS-42'); ?></a>
                            <?php else: ?>
                        ...
                        <div class="assessment-card <?php echo e($userYear !== 3 ? 'locked' : ''); ?>">
                            ...
                            <?php elseif(isset($completed_assessments) && in_array('Personality (NEO-FFI)', $completed_assessments)): ?>
                                <div class="position-absolute" style="top: 10px; left: 10px; color: var(--forest-green);">
                                    <i class="bi bi-check-circle-fill fs-5" title="Completed" data-bs-toggle="tooltip"></i>
                                </div>
                            <?php endif; ?>
                            ...
                            <button class="assessment-btn" <?php echo e($userYear !== 3 ? 'disabled' : ''); ?>
                                ...
                                onclick="openAssessment('neo')"><?php echo e($userYear !== 3 ? 'LOCKED' : ((isset($completed_assessments) && in_array('Personality (NEO-FFI)', $completed_assessments)) ? 'RETAKE NEO TEST' : 'START NEO TEST')); ?></button>
                        </div>
                        ...
                        <div class="assessment-card <?php echo e($userYear !== 4 ? 'locked' : ''); ?>">
                            ...
                            <?php elseif(isset($completed_assessments) && in_array('Work Values Inventory', $completed_assessments)): ?>
                                <div class="position-absolute" style="top: 10px; left: 10px; color: var(--forest-green);">
                                    <i class="bi bi-check-circle-fill fs-5" title="Completed" data-bs-toggle="tooltip"></i>
                                </div>
                            <?php endif; ?>
                            ...
                            <button class="assessment-btn" <?php echo e($userYear !== 4 ? 'disabled' : ''); ?>
                                ...
                                onclick="openAssessment('wvi')"><?php echo e($userYear !== 4 ? 'LOCKED' : ((isset($completed_assessments) && in_array('Work Values Inventory', $completed_assessments)) ? 'RETAKE WVI TEST' : 'START WVI TEST')); ?></button>
                        </div>
                        ...
                        <form method="POST" action="<?php echo e(route('assessments.grit.submit')); ?>" class="form-card">
                            ...
                            <div class="form-header text-center">
                                ...
                                <div class="progress-text" id="grit-progress-text">0% Complete
                                    (0/<?php echo e(count($grit_questions)); ?>)</div>
                            </div>
                            <div class="p-4">
                                ...
                                <div class="question-navigation" id="grit-navigation">
                                    ...
                                    <div class="question-counter" id="grit-counter">Question 1 of
                                        <?php echo e(count($grit_questions)); ?></div>
                        ...
                        <form method="POST" action="<?php echo e(route('assessments.neo.submit')); ?>" class="form-card">
                            ...
                            <div class="form-header text-center">
                                ...
                                <div class="progress-text" id="neo-progress-text">0% Complete
                                    (0/<?php echo e(count($neo_questions)); ?>)</div>
                            </div>
                            <div class="p-4">
                                ...
                                <div class="question-navigation" id="neo-navigation">
                                    ...
                                    <div class="question-counter" id="neo-counter">Question 1 of <?php echo e(count($neo_questions)); ?></div>
                        ...
                        <form method="POST" action="<?php echo e(route('assessments.wvi.submit')); ?>" class="form-card">
                            ...
                            <div class="form-header text-center">
                                ...
                                <div class="progress-text" id="wvi-progress-text">0% Complete
                                    (0/<?php echo e(count($wvi_questions)); ?>)</div>
                            </div>
                            <div class="p-4">
                                ...
                                <div class="question-navigation" id="wvi-navigation">
                                    ...
                                    <div class="question-counter" id="wvi-counter">Question 1 of <?php echo e(count($wvi_questions)); ?></div>
