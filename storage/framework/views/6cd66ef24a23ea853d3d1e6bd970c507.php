                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div style="z-index: 2; position: relative;">
                            ...
                            <p class="mb-0 opacity-90 fs-5">Share your feedback for <?php echo e($seminar->name); ?></p>
                        </div>
                        <div style="z-index: 2;">
                            <a href="<?php echo e(route('student.seminars.index')); ?>" class="btn btn-outline-light">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <div class="evaluate-card"
                            style="--seminar-color: <?php echo e($style['color']); ?>; --seminar-bg: <?php echo e($style['bg']); ?>;">
                            <div class="evaluate-header" style="background: var(--seminar-bg);">
                                <div class="rounded-circle bg-white shadow-sm d-flex align-items-center justify-content-center"
                                    ...
                                    <i class="bi <?php echo e($style['icon']); ?> fs-3" style="color: var(--seminar-color);"></i>
                                </div>
                                <div>
                                    <h3 class="mb-0 fw-bold" style="color: var(--seminar-color);"><?php echo e($seminar->name); ?></h3>
                                    <p class="mb-0 text-muted small"><?php echo e($seminar->description); ?></p>
                                </div>
                            </div>
                            <div class="p-4 p-md-5">
                                <form action="<?php echo e(route('student.seminars.store', $seminar->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>

                                    <?php if($seminar->name === 'IMAGE'): ?>
                                        <div class="mb-5">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-4 pb-3 border-bottom border-light">
                                                    <label class="form-label fw-bold d-block mb-3"><?php echo e($label); ?> <span
                                                            class="text-danger">*</span></label>
                                                    <div class="d-flex justify-content-between align-items-center"
                                                        ...
                                                        <?php for($i = 5; $i >= 1; $i--): ?>
                                                            <div class="form-check form-check-inline text-center mx-0">
                                                                <input class="form-check-input d-block mx-auto mb-1" type="radio"
                                                                    name="answers[<?php echo e($key); ?>]" id="<?php echo e($key); ?>_<?php echo e($i); ?>" value="<?php echo e($i); ?>"
                                                                    required>
                                                                <label class="form-check-label small fw-bold" for="<?php echo e($key); ?>_<?php echo e($i); ?>">
                                                                    <?php echo e($i); ?>

                                                                    <div
                                                                        style="font-size: 0.65rem; font-weight: normal; margin-top: 2px;">
                                                                        <?php if($i == 5): ?> Strongly Agree
                                                                        <?php elseif($i == 4): ?> Highly Agree
                                                                        <?php elseif($i == 3): ?> Agree
                                                                        <?php elseif($i == 2): ?> Disagree
                                                                        <?php elseif($i == 1): ?> Strongly Disagree
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </label>
                                                            </div>
                                    ...
                                    <?php elseif($seminar->name === 'IDREAMS'): ?>
                                        <div class="mb-5">
                                            <h4 class="fw-bold seminar-section-title">Seminar Questions</h4>
                                            ...
                                            <?php $__currentLoopData = $idreams_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-4">
                                                    <label class="form-label fw-bold"><?php echo e($data['label']); ?> <span
                                                            class="text-danger">*</span></label>
                                                    <div class="row g-2">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div
                                                                    ...
                                                                    <input class="form-check-input ms-0 me-2" type="radio"
                                                                        ...
                                                                        id="<?php echo e($key); ?>_<?php echo e(Str::slug($option)); ?>" value="<?php echo e($option); ?>"
                                                                        required>
                                                                    <label class="form-check-label w-100 cursor-pointer"
                                                                        for="<?php echo e($key); ?>_<?php echo e(Str::slug($option)); ?>">
                                                                        <?php echo e($option); ?>
                                    ...
                                    <?php elseif($seminar->name === '10C'): ?>
                                        <div class="mb-5">
                                            ...
                                            <?php $__currentLoopData = $ten_c_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-4">
                                                    <label class="form-label fw-bold"><?php echo e($data['label']); ?> <span
                                                            class="text-danger">*</span></label>
                                                    <div class="row g-2">
                                    ...
                                    <?php elseif($seminar->name === 'LEADS'): ?>
                                        <div class="mb-5">
                                            ...
                                            <?php $__currentLoopData = $leads_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-4">
                                                    <label class="form-label fw-bold"><?php echo e($data['label']); ?> <span
                                                            class="text-danger">*</span></label>
                                                    <div class="row g-2">
                                                        <?php $__currentLoopData = $data['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="<?php echo e($key === 'q10' ? 'col-md-6' : 'col-md-6 col-lg-3'); ?>">
                                                                <div
                                                                    class="form-check p-2 border rounded hover-bg-light transition-all">
                                                                    <input class="form-check-input ms-0 me-2" type="radio"
                                                                        name="answers[<?php echo e($key); ?>]"
                                        ...
                                        <input type="hidden" name="rating" value="5">
                                    <?php elseif($seminar->name === 'New Student Orientation Program'): ?>
                                            <div class="mb-5">
                                                ...
                                                <?php $__currentLoopData = $orientation_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="mb-4">
                                                        <label class="form-label fw-bold"><?php echo e($data['label']); ?> <span class="text-danger">*</span></label>
                                                        <div class="row g-2">
                                                            <?php $__currentLoopData = $data['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="col-12">
                                                                    <div class="form-check p-2 border rounded hover-bg-light transition-all">
                                                                        <input class="form-check-input ms-0 me-2" type="radio"
                                                                            name="answers[<?php echo e($key); ?>]"
                                                                            id="<?php echo e($key); ?>_<?php echo e(Str::slug(substr($option, 0, 20))); ?>" value="<?php echo e($option); ?>"
                                                                            required>
                                                                        <label class="form-check-label w-100 cursor-pointer"
                                                                            for="<?php echo e($key); ?>_<?php echo e(Str::slug(substr($option, 0, 20))); ?>">
                                                                            <?php echo e($option); ?>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="mb-4 pb-3 border-bottom border-light">
                                                        <label class="form-label fw-bold d-block mb-3"><?php echo e($label); ?> <span class="text-danger">*</span></label>
                                                        <div class="d-flex justify-content-between align-items-center" style="max-width: 800px; margin: 0 auto;">
                                                            <?php for($i = 5; $i >= 1; $i--): ?>
                                                                <div class="form-check form-check-inline text-center mx-0">
                                                                    <input class="form-check-input d-block mx-auto mb-1" type="radio"
                                                                        name="answers[<?php echo e($key); ?>]" id="<?php echo e($key); ?>_<?php echo e($i); ?>" value="<?php echo e($i); ?>" required>
                                                                    <label class="form-check-label small fw-bold" for="<?php echo e($key); ?>_<?php echo e($i); ?>">
                                                                        <?php echo e($i); ?>

                                                                        <div style="font-size: 0.65rem; font-weight: normal; margin-top: 2px;">
                                                                            <?php if($i == 5): ?> Excellent
                                                                            <?php elseif($i == 4): ?> Very Good
                                                                            <?php elseif($i == 3): ?> Good
                                                                            <?php elseif($i == 2): ?> Satisfactory
                                                                            <?php elseif($i == 1): ?> Needs Imp.
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </label>
                                                                </div>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <dir class="ps-0 mb-4">
                                                    ...
                                                    <?php $__currentLoopData = [
                                                        ...
                                                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="answers[cc1]" id="cc1_<?php echo e($val); ?>" value="<?php echo e($val); ?>" required>
                                                                    <label class="form-check-label" for="cc1_<?php echo e($val); ?>"><?php echo e($text); ?></label>
                                                                </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </dir>
                                                ...
                                                <dir class="ps-0 mb-4">
                                                    ...
                                                    <?php $__currentLoopData = [
                                                            ...
                                                            '5' => "5. N/A"
                                                                ...
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="answers[cc2]" id="cc2_<?php echo e($val); ?>" value="<?php echo e($val); ?>" required>
                                                                    <label class="form-check-label" for="cc2_<?php echo e($val); ?>"><?php echo e($text); ?></label>
                                                                </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </dir>
                                                ...
                                                <dir class="ps-0 mb-4">
                                                    ...
                                                    <?php $__currentLoopData = [
                                                            ...
                                                            '4' => "4. N/A"
                                                                ...
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="answers[cc3]" id="cc3_<?php echo e($val); ?>" value="<?php echo e($val); ?>" required>
                                                                    <label class="form-check-label" for="cc3_<?php echo e($val); ?>"><?php echo e($text); ?></label>
                                                                </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </dir>
                                            </div>
                                                ...
                                                ?>
                                                 ...
                                                 <div class="table-responsive">
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $sqd_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr class="border-bottom">
                                                                    <td class="fw-bold small py-3"><?php echo e($label); ?> <span class="text-danger">*</span></td>
                                                                    <?php $__currentLoopData = ['Strongly Disagree', 'Disagree', 'Neither agree nor Disagree', 'Agree', 'Strongly Agree', 'N/A']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <td class="text-center py-3">
                                                                            <div class="form-check d-flex justify-content-center">
                                                                                <input class="form-check-input" type="radio" name="answers[<?php echo e($key); ?>]" value="<?php echo e($opt); ?>" required>
                                                                            </div>
                                                                        </td>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/student/seminars/evaluate.blade.php ENDPATH**/ ?>