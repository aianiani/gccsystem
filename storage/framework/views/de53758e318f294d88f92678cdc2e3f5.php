                    ...
                    <div class="container py-1">
                        ...
                        <div class="appointments-hero d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="opacity-75 small">Review your completed session history and provide feedback
                                </div>
                            </div>
                                        ...
                                        <div class="appointment-card">
                                            <div class="appointment-header d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <?php else: ?>
                                                        <div
                                                            class="counselor-avatar d-flex align-items-center justify-content-center bg-success text-white">
                                                            <?php echo e(strtoupper(substr($appointment->counselor->name ?? 'C', 0, 1))); ?>

                                                        </div>
                                                    <?php endif; ?>
                                                    <div>
                                                        <h6 class="mb-0 fw-bold"><?php echo e($appointment->counselor->name ?? 'Counselor'); ?>
                                            ...
                                            <div class="appointment-body">
                                                <div class="row mb-4">
                                                    <div class="col-md-6 mb-2">
                                                        <div class="d-flex align-items-center text-muted">
                                                            ...
                                                            <span
                                                                class="fw-medium text-dark"><?php echo e($appointment->scheduled_at->format('F j, Y')); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <div class="d-flex align-items-center text-muted">
                                                            <i class="bi bi-clock me-2"></i>
                                                            <span><?php echo e($appointment->scheduled_at->format('g:i A')); ?> -
                                                                <?php echo e($appointment->scheduled_at->addMinutes(30)->format('g:i A')); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="session-note">
                                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                                            <h6 class="fw-bold text-success mb-0">
                                                                <i class="bi bi-journal-text me-2"></i>Session
                                                                <?php echo e($completedAppointments->count() - $loop->parent->index); ?>

                                                            </h6>
                                                            <small
                                                                class="text-muted"><?php echo e($sessionNote->created_at->format('M j, g:i A')); ?></small>
                                                        </div>
                                                        ...
                                                        <?php if($sessionNote->content): ?>
                                                            <div class="mb-3">
                                                                <div class="bg-white p-3 rounded border">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <div class="text-muted fst-italic">Private note — visible only to your
                                                                            counselor.</div>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="feedback-section">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <?php if($existingFeedback): ?>
                                                                <div class="d-flex align-items-center gap-2 mt-2">
                                                                    <div class="d-flex">
                                                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                                                            <i
                                                                                class="bi bi-star<?php echo e($i <= $existingFeedback->rating ? '-fill' : ''); ?> text-warning"></i>
                                                                        <?php endfor; ?>
                                                                    </div>
                                                                    <span
                                                                        class="text-muted small">(<?php echo e($existingFeedback->rating); ?>/5)</span>
                                                                </div>
                                                                <p class="mb-0 text-muted small mt-1">
                                                                    <?php echo e(Str::limit($existingFeedback->comments, 100)); ?></p>
                                                            <?php else: ?>
                                                        ...
                                                        <?php if(!$existingFeedback): ?>
                                                            <a href="<?php echo e(route('session-feedback.create', $appointment->id)); ?>"
                                                                class="btn btn-outline-success btn-sm rounded-pill px-4">
                                                                Provide Feedback
                                                            </a>
                                                        <?php else: ?>
                                                            <span
                                                                class="badge bg-light text-success border border-success rounded-pill px-3">
