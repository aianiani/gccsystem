        ...
        <div class="d-flex">
            ...
            <div class="main-dashboard-content flex-grow-1">
                <div class="main-dashboard-inner">
                    <div class="mb-6">
                        <a href="<?php echo e(route('counselor.seminars.index')); ?>" class="btn-secondary-custom">
                    ...
                    <div class="content-card">
                        ...
                        <div class="p-6">
                            <form action="<?php echo e(route('counselor.seminars.update', $seminar)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>

                                <div class="mb-4">
                                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Seminar Name</label>
                                    <input type="text" name="name" id="name" value="<?php echo e($seminar->name); ?>"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                        class="form-control-custom w-full"><?php echo e($seminar->description); ?></textarea>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select name="target_year_level" id="target_year_level" class="form-select-custom w-full"
                                        required>
                                        <option value="1" <?php echo e($seminar->target_year_level == 1 ? 'selected' : ''); ?>>1st Year</option>
                                        <option value="2" <?php echo e($seminar->target_year_level == 2 ? 'selected' : ''); ?>>2nd Year</option>
                                        <option value="3" <?php echo e($seminar->target_year_level == 3 ? 'selected' : ''); ?>>3rd Year</option>
                                        <option value="4" <?php echo e($seminar->target_year_level == 4 ? 'selected' : ''); ?>>4th Year</option>
                                    </select>
                                </div>
                    ...
                    <div class="content-card">
                        ...
                        <div class="p-6">
                            <!-- Add Schedule Form -->
                            <form action="<?php echo e(route('counselor.seminars.schedules.store', $seminar)); ?>" method="POST"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-48 overflow-y-auto border border-gray-200 rounded p-2 bg-white">
                                            ...
                                            <?php $__currentLoopData = $colleges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $college): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex items-center">
                                                    <input type="checkbox" name="colleges[]" value="<?php echo e($college); ?>" id="college_<?php echo e($loop->index); ?>" class="mr-2">
                                                    <label for="college_<?php echo e($loop->index); ?>" class="text-sm text-gray-700"><?php echo e($college); ?></label>
                                                </div>
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full table-custom text-sm">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $seminar->schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="align-top">
                                                    <div class="font-bold text-gray-800 text-base mb-1"><?php echo e($schedule->date->format('F d, Y')); ?></div>
                                                    <div class="flex items-center gap-2 mb-1">
                                                        <span class="px-2 py-1 rounded text-xs font-semibold <?php echo e($schedule->session_type === 'Morning' ? 'bg-yellow-100 text-yellow-800' : 'bg-orange-100 text-orange-800'); ?>">
                                                            <?php echo e($schedule->session_type); ?> Session
                                                        </span>
                                                        <span class="text-xs text-gray-500 font-medium">
                                                            <?php if($schedule->session_type === 'Morning'): ?>
                                                                (8:00 AM - 12:00 PM)
                                                            <?php else: ?>
                                                                (1:00 PM - 5:00 PM)
                                                            <?php endif; ?>
                                                    ...
                                                    <div class="text-xs text-gray-400">AY <?php echo e($schedule->academic_year); ?></div>
                                                </td>
                                                <td class="align-top font-medium text-gray-700">
                                                    <div class="flex items-start gap-2">
                                                        <i class="bi bi-geo-alt-fill text-gray-400 mt-1"></i>
                                                        <span><?php echo e($schedule->location ?? 'N/A'); ?></span>
                                                    </div>
                                                </td>
                                                <td class="align-top">
                                                    <?php if($schedule->colleges): ?>
                                                        <div class="flex flex-wrap gap-1">
                                                            <?php $__currentLoopData = $schedule->colleges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $college): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/counselor/seminars/edit.blade.php ENDPATH**/ ?>