    ...
    <div class="main-dashboard-inner home-zoom">
        ...
        <div class="page-header">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('activities.export', request()->all())); ?>"
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e(number_format($stats['today'])); ?></h3>
                    <p>Events Today</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e(number_format($stats['logins_today'])); ?></h3>
                    <p>Logins Today</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e(number_format($stats['security_events'])); ?></h3>
        ...
        <div class="filter-bar">
            <form method="GET" action="<?php echo e(route('activities')); ?>" id="filterForm">
                <div class="row g-3">
                    <!-- Search -->
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="filter-select" name="role" onchange="this.form.submit()">
                            ...
                            <option value="counselor" <?php echo e(request('role') == 'counselor' ? 'selected' : ''); ?>>Counselor</option>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="date" class="filter-input" name="date_from" value="<?php echo e(request('date_from')); ?>" onchange="this.form.submit()">
                    </div>

                    <!-- Date To -->
                    <div class="col-md-2">
                        <label class="filter-label">To Date</label>
                        <input type="date" class="filter-input" name="date_to" value="<?php echo e(request('date_to')); ?>" onchange="this.form.submit()">
                    </div>

                    <!-- Clear Filter -->
                    <div class="col-md-1 d-flex align-items-end">
                        <?php if(request()->anyFilled(['search', 'action', 'role', 'date_from', 'date_to'])): ?>
                            <a href="<?php echo e(route('activities')); ?>" class="btn btn-outline-danger w-100" style="height: 38px;" title="Clear Filters">
            ...
            <?php if($activities->count() > 0): ?>
                    ...
                    <table class="premium-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="ps-4">
                                        <input type="checkbox" class="form-check-input item-checkbox" value="<?php echo e($activity->id); ?>">
                                    </td>
                                    <td>
                                        <?php if($activity->user): ?>
                                            <div class="user-cell">
                                                <?php if($activity->user->avatar): ?>
                                                    <img src="<?php echo e(asset('storage/avatars/' . $activity->user->avatar)); ?>" alt="Avatar" class="user-avatar">
                                                <?php else: ?>
                                                ...
                                                <?php endif; ?>
                                                <div class="user-info">
                                                    <h6><?php echo e($activity->user->name); ?></h6>
                                                    <span><?php echo e($activity->user->email); ?></span>
                                                </div>
                                            </div>
                                        <?php else: ?>
                                            <div class="user-cell">
                                    ...
                                    <td>
                                        <?php if($activity->user): ?>
                                            <span class="premium-badge badge-role-<?php echo e($activity->user->role); ?>">
                                                <?php echo e(ucfirst($activity->user->role)); ?>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span class="premium-badge badge-action-<?php echo e($actionType); ?>">
                                            <?php echo e(ucfirst(str_replace('_', ' ', $activity->action))); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <div class="details-cell" title="<?php echo e($activity->description); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column small">
                                            <span class="text-muted mb-1"><i class="bi bi-globe me-1"></i><?php echo e($activity->ip_address); ?></span>
                                            <span class="text-muted d-none d-lg-block" title="<?php echo e($activity->user_agent); ?>">
                                                <i class="bi bi-browser-chrome me-1"></i><?php echo e(Str::limit($activity->user_agent, 15)); ?>

                                            </span>
                                        </div>
                                    </td>
                                    <td class="text-end pe-4">
                                        <div class="fw-medium text-dark"><?php echo e($activity->created_at->format('M d, Y')); ?></div>
                                        <div class="text-muted" style="font-size: 0.75rem;"><?php echo e($activity->created_at->format('h:i A')); ?></div>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                ...
                <div class="d-flex justify-content-between align-items-center p-3 border-top">
                    <div class="text-muted small">
                        Showing <strong><?php echo e($activities->firstItem() ?? 0); ?></strong> - <strong><?php echo e($activities->lastItem() ?? 0); ?></strong>
                        of <strong><?php echo e($activities->total()); ?></strong>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <select class="form-select form-select-sm" style="width: auto; border-radius: 6px;"
                            onchange="window.location.href='<?php echo e(route('activities', array_merge(request()->query(), ['per_page' => '']))); ?>' + this.value">
                        ...
                        <?php echo e($activities->links('vendor.pagination.premium-simple')); ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="bulkDeleteForm" method="POST" action="<?php echo e(route('activities.bulk-delete')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/activities.blade.php ENDPATH**/ ?>