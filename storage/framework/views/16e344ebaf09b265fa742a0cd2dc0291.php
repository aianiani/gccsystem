        ...
        <div class="page-header-card">
            ...
            <div>
                <span class="badge bg-light text-dark fs-6 px-3 py-2">
                    <i class="bi bi-list-ul me-1"></i><?php echo e($activities->total()); ?> total activities
                </span>
            </div>
        </div>
        ...
        <div class="main-content-card">
            <div class="card-header">
                ...
                <div class="d-flex align-items-center gap-2">
                    <span class="badge bg-primary"><?php echo e($activities->count()); ?> shown</span>
                </div>
            </div>
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <?php if($activity->user): ?>
                                                    <div class="d-inline-flex align-items-center justify-content-center bg-primary bg-opacity-10 rounded-circle me-3 shadow"
                                                        ...
                                                        <img src="<?php echo e($activity->user->avatar_url); ?>" alt="Avatar" class="rounded-circle"
                                                            width="36" height="36">
                                                    </div>
                                                <?php else: ?>
                                                ...
                                                <?php endif; ?>
                                                <div>
                                                    <div class="fw-semibold"><?php echo e($activity->user->name ?? 'Unknown'); ?></div>
                                                    <small class="text-muted"><?php echo e($activity->user->email ?? 'Unknown'); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-<?php echo e(getActivityBadgeColor($activity->action)); ?> fs-6 px-3 py-2">
                                                <i class="bi bi-<?php echo e(getActivityIcon($activity->action)); ?> me-1"></i>
                                        ...
                                        <td>
                                            <small class="text-muted">
                                                <i class="bi bi-globe me-1"></i><?php echo e($activity->ip_address ?? 'N/A'); ?>

                                            </small>
                                        </td>
                                        <td>
                                            <small class="text-muted">
                                                <i class="bi bi-browser-chrome me-1"></i><?php echo e(getBrowserName($activity->user_agent)); ?>

                                            </small>
                                        </td>
                                        <td class="pe-4">
                                            <div>
                                                <div class="fw-medium"><?php echo e($activity->created_at->format('M d, Y')); ?></div>
                                                <small class="text-muted">
                                                    <i class="bi bi-clock me-1"></i><?php echo e($activity->created_at->format('H:i:s')); ?>
