                ...
                <div class="main-dashboard-inner">
                    ...
                    <div class="main-content-card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        <div class="card-body p-3">
                            <form action="<?php echo e(route('counselor.feedback.index')); ?>" method="GET" class="row g-3">
                                <div class="col-md-4">
                                    <div class="search-box position-relative">
                                        <i class="bi bi-search position-absolute top-50 start-0 translate-middle-y ms-3 text-muted"></i>
                                        <input type="text" name="student" class="filter-control ps-5"
                                            placeholder="Search student or ID..." value="<?php echo e(request('student')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <select name="per_page" class="filter-select w-100">
                                        <?php $__currentLoopData = [10, 20, 30, 50, 100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($count); ?>"
                                                <?php echo e(request('per_page') == $count ? 'selected' : ''); ?>>
                                                <?php echo e($count); ?> Per Page
                                            </option>
                                ...
                                <div class="col-md-4 d-flex gap-2">
                                    ...
                                    <a href="<?php echo e(route('counselor.feedback.index')); ?>" class="btn-reset">
                    ...
                    <form id="bulk-delete-form" action="<?php echo e(route('counselor.feedback.bulkDestroy')); ?>" method="POST"
                        style="display: none;">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="main-content-card border-0 shadow-sm rounded-4 overflow-hidden">
                        <div class="card-body p-0">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="ps-4">
                                                    <div class="custom-checkbox">
                                                        <input type="checkbox" class="item-checkbox" id="check-<?php echo e($feedback->id); ?>"
                                                            value="<?php echo e($feedback->id); ?>">
                                                        <label for="check-<?php echo e($feedback->id); ?>"></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e($feedback->appointment->student->avatar_url); ?>"
                                                            class="user-avatar" alt="">
                                                        <div class="user-details">
                                                            <h6><?php echo e($feedback->appointment->student->name); ?></h6>
                                                            <span><?php echo e($feedback->appointment->student->student_id ?? '-'); ?> •
                                                                <?php echo e($feedback->appointment->student->college ?? ''); ?></span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <div class="star-rating d-flex text-warning">
                                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                                <i
                                                                    class="bi bi-star<?php echo e($i <= $feedback->rating ? '-fill' : ''); ?>"></i>
                                                            <?php endfor; ?>
                                                        </div>
                                                        <span class="small text-muted fw-semibold mt-1"><?php echo e($feedback->rating); ?>/5
                                                            Rating</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="comments-preview" title="<?php echo e($feedback->comments); ?>">
                                                        "<?php echo e($feedback->comments); ?>"
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span
                                                            class="fw-semibold"><?php echo e($feedback->created_at->format('M d, Y')); ?></span>
                                                        <span
                                                            class="text-muted small"><?php echo e($feedback->created_at->format('g:i A')); ?></span>
                                                    </div>
                                                </td>
                                                <td class="pe-4 text-end">
                                                    <div class="actions-cell justify-content-end">
                                                        <a href="<?php echo e(route('counselor.feedback.show', $feedback->id)); ?>"
                                                            class="btn-action view" title="View Details">
                                                            <i class="bi bi-eye-fill"></i>
                                                        </a>
                                                        <button type="button" class="btn-action delete" title="Delete"
                                                            onclick="confirmDelete(<?php echo e($feedback->id); ?>)">
                                                            <i class="bi bi-trash3-fill"></i>
                                                        </button>
                                                        <form id="delete-form-<?php echo e($feedback->id); ?>"
                                                            action="<?php echo e(route('counselor.feedback.bulkDestroy')); ?>"
                                                            method="POST" class="d-none">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <input type="hidden" name="ids[]" value="<?php echo e($feedback->id); ?>">
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="pagination-wrap">
                                <?php echo e($feedbacks->links('vendor.pagination.premium')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Laravel Projects\gccsystem\resources\views/counselor/feedback/index.blade.php ENDPATH**/ ?>