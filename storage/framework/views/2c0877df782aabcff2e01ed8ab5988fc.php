                                            ...
                                            <tr>
                                                <td class="ps-4 py-3">
                                                    <div class="d-flex align-items-center">
                                                        <?php if($feedback->appointment->student->avatar): ?>
                                                            <img src="<?php echo e($feedback->appointment->student->avatar_url); ?>" alt=""
                                                        ...
                                                        <?php else: ?>
                                                            <div class="rounded-circle bg-success text-white d-flex align-items-center justify-content-center me-3"
                                                                ...
                                                                <?php echo e(strtoupper(substr($feedback->appointment->student->name, 0, 1))); ?>

                                                            </div>
                                                        <?php endif; ?>
                                                        <div>
                                                            <div class="fw-bold text-dark" style="font-size: 1rem;">
                                                                <?php echo e($feedback->appointment->student->name); ?></div>
                                                            <div class="small text-muted">
                                                                <?php echo e($feedback->appointment->student->email); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-3">
                                                    ...
                                                    <span class="small fw-semibold text-muted ms-1"><?php echo e($feedback->rating); ?>/5</span>
                                                </td>
                                                <td class="py-3">
                                                ...
                                                <td class="py-3 text-muted small">
                                                    <div class="fw-semibold"><?php echo e($feedback->created_at->format('M d, Y')); ?></div>
                                                    <div class="text-xs text-muted"><?php echo e($feedback->created_at->format('h:i A')); ?>
