                                ...
                                <tbody>
                                    <?php for($year = 1; $year <= 4; $year++): ?>
                                        <tr class="transition-colors hover:bg-gray-50 <?php echo e($student->year_level == $year ? 'bg-green-50/50' : ''); ?>">
                                            ...
                                            <?php $__currentLoopData = ['IDREAMS', '10C', 'LEADS', 'IMAGE']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $seminar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php if($year == $index + 1): ?>
                                                            <div class="form-check d-flex justify-content-center m-0">
                                                                <input type="checkbox" 
                                                                       ...
                                                                       <?php echo e(isset($attendanceMatrix[$year][$seminar]) ? 'checked' : ''); ?>>
                                                            </div>
                                                        <?php else: ?>
