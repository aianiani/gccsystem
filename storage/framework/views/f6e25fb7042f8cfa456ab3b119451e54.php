                            ...
                            <div class="dashboard-stat-card ps-3 pe-3">
                                <div class="stat-content">
                                    ...
                                    <div class="averages-grid">
                                        <div class="avg-item">
                                            <div class="avg-val" style="color: #0d6efd;"><?php echo e($genderStats['male'] ?? 0); ?></div>
                                            <div class="avg-label">Male</div>
                                        </div>
                                        <div class="avg-item">
                                            <div class="avg-val" style="color: #d63384;"><?php echo e($genderStats['female'] ?? 0); ?></div>
                        ...
                        <form method="GET" action="<?php echo e(route('counselor.students.index')); ?>" class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-select" id="gender" name="gender">
                                    ...
                                    <option value="female" <?php echo e(request('gender') == 'female' ? 'selected' : ''); ?>>Female
                                    </option>
                                    <option value="non-binary" <?php echo e(request('gender') == 'non-binary' ? 'selected' : ''); ?>>
                                        Non-binary</option>
                                    <option value="prefer_not_to_say" <?php echo e(request('gender') == 'prefer_not_to_say' ? 'selected' : ''); ?>>Prefer not to say</option>
