                ...
                <div class="main-dashboard-inner">
                            ...
                            <div class="d-flex align-items-center gap-4">
                                ...
                                <div>
                                    <div class="welcome-date mb-1 opacity-75"><i
                                            class="bi bi-calendar-event me-2"></i><?php echo e(now()->format('F j, Y')); ?></div>
                        ...
                        <div class="dashboard-stats">
                            <div class="dashboard-stat-card">
                                ...
                                <div class="stat-subtitle">
                                    <?php echo e($studentStats['totalSessions']); ?>/<?php echo e($studentStats['totalScheduled']); ?> completed
                                </div>
                                <div class="stat-progress">
                                    <div class="stat-progress-bar progress-success"
                                        style="width: <?php echo e($studentStats['sessionProgress']); ?>%"></div>
                                </div>
                            </div>
                            ...
                            <div class="dashboard-stat-card">
                                ...
                                <div class="stat-progress">
                                    <div class="stat-progress-bar progress-info"
                                        style="width: <?php echo e($studentStats['assessmentProgress']); ?>%"></div>
                                </div>
                            </div>
                            ...
                            <div class="dashboard-stat-card">
                                ...
                                <div class="stat-progress">
                                    <div class="stat-progress-bar progress-info" style="width: <?php echo e($seminarProgress); ?>%">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="text-muted small mb-2">
                                                <i class="bi bi-calendar-event me-1"></i><?php echo e($start->format('F j, Y')); ?> &bull;
                                ...
                                <div class="announcement-item p-0 mb-4 overflow-hidden border bg-white"
                                    ...
                                    <?php if(!empty($announcement->images) && is_array($announcement->images) && count($announcement->images) > 0): ?>
                                        <div class="announcement-image" style="height: 250px; overflow: hidden;">
                                            <img src="<?php echo e(asset('storage/' . $announcement->images[0])); ?>" alt="Announcement Image"
                    ...
                    <div class="main-content-card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo e(route('chat.selectCounselor')); ?>" class="btn btn-light btn-sm"
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="message-preview">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <h6 class="mb-0 fw-bold"><?php echo e($message['sender_name']); ?></h6>
                                        <small class="text-muted"><?php echo e($message['time_ago']); ?></small>
                                    </div>
                                    <p class="mb-0 text-muted"><?php echo e(Str::limit($message['content'], 80)); ?></p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="empty-state">
                                    <i class="bi bi-chat-dots"></i>
                                    <p class="mb-2">No recent messages</p>
                                    <a href="<?php echo e(route('chat.selectCounselor')); ?>" class="btn btn-outline-success btn-sm">
        ...
        <div class="modal-dialog modal-dialog-centered dass-modal">
            <div class="modal-content">
                ...
                <div class="dass-modal-footer">
                    ...
                    <a href="<?php echo e(route('consent.show')); ?>" class="btn btn-success">
                        Proceed
                    </a>
                </div>
            </div>
