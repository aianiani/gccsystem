                                    ...
                                    <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seminarName => $style): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-center gap-2 px-3 py-2 rounded-3 border transition-all text-center
                                            ...
                                            <?php if($isCompleted): ?>
                                                ...
                                                <span class="fw-bold small"><?php echo e($style['label'] ?? $seminarName); ?></span>
                                            <?php else: ?>
                                                <i class="bi bi-lock-fill opacity-50"></i>
                                                <span class="small opacity-75"><?php echo e($style['label'] ?? $seminarName); ?></span>
                                            <?php endif; ?>
                                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered dass-modal">
                    <div class="modal-content">
                        ...
                        <div class="dass-modal-footer">
                            ...
                            <a href="<?php echo e(route('consent.show')); ?>" class="btn btn-success px-4 fw-semibold">
