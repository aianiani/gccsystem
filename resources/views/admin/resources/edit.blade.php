    ...
    <div class="main-dashboard-inner home-zoom">
        <div class="page-header-card">
            <div>
                ...
                <p>Update "{{ $resource->title }}"</p>
            </div>
            <div>
                <a href="{{ route('admin.resources.index') }}" class="btn btn-light text-success fw-bold">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="3" placeholder="Briefly describe what this resource is about...">{{ old('description', $resource->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="type-selector">
                                    <label class="type-option" data-type="video">
                                        <input type="radio" name="type" value="video" class="d-none"
                                            {{ old('type', $resource->type) == 'video' ? 'checked' : '' }}>
                                    ...
                                    <label class="type-option" data-type="image">
                                        <input type="radio" name="type" value="image" class="d-none"
                                            {{ old('type', $resource->type) == 'image' ? 'checked' : '' }}>
                                    ...
                                    <label class="type-option" data-type="file">
                                        <input type="radio" name="type" value="file" class="d-none"
                                            {{ old('type', $resource->type) == 'file' ? 'checked' : '' }}>
                                    ...
                                    <label class="type-option" data-type="article">
                                        <input type="radio" name="type" value="article" class="d-none"
                                            {{ old('type', $resource->type) == 'article' ? 'checked' : '' }}>
                            ...
                            @if ($resource->file_path)
                                <div class="current-file-card" id="currentFileCard">
                                    ...
                                    <div class="file-info">
                                        <h6>{{ $resource->file_name ?? 'Uploaded File' }}</h6>
                                        <small>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" class="form-control @error('content') is-invalid @enderror"
                                            ...
                                            value="{{ old('content', $resource->file_path ? '' : $resource->content) }}"
                                            placeholder="https://...">
                                    </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body py-3">
                            <div class="resource-meta">
                                <div class="meta-item">
                                    ...
                                    <span class="meta-value">{{ $resource->created_at->format('M d, Y') }}</span>
                                </div>
                                <div class="meta-item">
                                    <span class="meta-label">Last Updated</span>
                                    <span class="meta-value">{{ $resource->updated_at->format('M d, Y') }}</span>
                                </div>
                                <div class="meta-item">
                    ...
                    <div class="main-content-card">
                        ...
                        <div class="card-body">
                            <select class="form-select @error('category') is-invalid @enderror" id="category"
                                ...
                                @foreach (['Mental Health', 'Orientation', 'Academic Support', 'Career Guidance', 'Other'] as $cat)
                                    <option value="{{ $cat }}"
                    ...
                    <div class="main-content-card">
                        ...
                        <div class="card-body">
                            <div class="preview-card" id="previewArea">
                                @if ($resource->file_path && str_starts_with($resource->file_type ?? '', 'image/'))
                                    <img src="{{ asset('storage/' . $resource->file_path) }}" alt="Preview"
                                        style="max-width: 100%; max-height: 150px; border-radius: 8px;">
                                    <p class="mt-2">{{ $resource->file_name }}</p>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('admin.resources.index') }}" class="btn btn-light border">
                            Cancel
                        </a>
                    </div>
                </div>
