                    ...
                    <tbody>
                        @for($i = 1; $i <= 21; $i++)
                            ...
                            <tr>
                                ...
                                <td
                                    style="border:1px solid #ddd; padding:6px; text-align:center; color:{{ $getCategoryColor($q1) }}; font-weight:700;">
                                    {{ $q1_ans }}</td>
                                <td style="border:1px solid #ddd; padding:6px; text-align:center;">{{ $q2 }}</td>
                                <td
                                    style="border:1px solid #ddd; padding:6px; text-align:center; color:{{ $getCategoryColor($q2) }}; font-weight:700;">
                                    {{ $q2_ans }}</td>
                                <td
            ...
            <table class="key-scores" style="width:100%; margin-bottom:8px;">
                <tr>
                    <td style="width:33%;"><strong>Depression</strong>
                        <div class="small">Score: {{ $computedDep }}</div>
                        <div style="margin-top:6px;"><span
                                class="badge bg-depression">{{ $localInterpretation['depression'] }}</span></div>
                    </td>
                    <td style="width:33%;"><strong>Anxiety</strong>
                        <div class="small">Score: {{ $computedAnx }}</div>
                        <div style="margin-top:6px;"><span
                                class="badge bg-anxiety">{{ $localInterpretation['anxiety'] }}</span></div>
                    </td>
                    <td style="width:34%;"><strong>Stress</strong>
                        <div class="small">Score: {{ $computedStr }}</div>
                        <div style="margin-top:6px;"><span
                                class="badge bg-stress">{{ $localInterpretation['stress'] }}</span></div>
                    </td>
                </tr>
            </table>
        @else
