                                ...
                                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        @if($appointment->status === 'accepted' || $appointment->status === 'completed')
                                            ...
                                            @endphp
                                            @if($existingNote)
                                                <a href="{{ route('counselor.session_notes.show', $existingNote->id) }}"
                                                    class="btn btn-outline-warning btn-action text-dark">
                                                    <i class="bi bi-journal-text"></i> View Note
                                                </a>
                                            @else
                                                <a href="{{ route('counselor.session_notes.create', $appointment->id) }}"
                                                    class="btn btn-warning btn-action text-dark">
                                            ...
                                            @if($appointment->appointment_type === 'Referral')
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12 info-group">
                                                        ...
                                                        <div class="info-value">
                                                            {{ $appointment->referrer_name ?? 'Not specified' }}</div>
                                                    </div>
                                                    <div class="col-12 info-group">
                                                        <div class="info-label">Reason for Referral</div>
                                                        <div class="info-value">
                                                            {{ $appointment->referral_reason ?? 'Not specified' }}</div>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="content-card h-100">
                                            <div class="student-profile-header mb-4">
                                                ...
                                                <div class="badge bg-light text-dark border">
                                                    {{ $appointment->student->student_id ?? 'No ID' }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="info-group">
                                                ...
                                                <div class="info-value text-break">
                                                    ...
                                                    {{ $appointment->student->contact_number ?? 'N/A' }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-6 info-group">
                                                    ...
                                                    <div class="info-value">{{ $appointment->student->year_level ?? 'N/A' }}
                                                    </div>
                                                </div>
                                                <div class="col-6 info-group">
                                                    <div class="info-label">Course</div>
                                                    <div class="info-value">{{ $appointment->student->course ?? 'N/A' }}
                                                    </div>
                                                </div>
                                                <div class="col-6 info-group">
                                                    <div class="info-label">Sex</div>
                                                    <div class="info-value">
                                                        {{ ucfirst($appointment->student->sex ?? 'N/A') }}</div>
                                                </div>
                                            </div>
                            ...
                            <div class="content-card mb-4">
                                ...
                                <div id="guardianPrivacyContainer" class="privacy-blur">
                                    <div class="info-group">
                                        ...
                                        <div class="small text-muted">{{ $appointment->guardian1_relationship }} •
                                            {{ $appointment->guardian1_contact }}
                                        </div>
                                    </div>
                                    @if($appointment->guardian2_name)
                                        ...
                                        <div class="info-group">
                                            ...
                                            <div class="small text-muted">{{ $appointment->guardian2_relationship }} •
                                                {{ $appointment->guardian2_contact }}
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="content-card p-0 overflow-hidden">
                                    ...
                                    <div class="list-group list-group-flush">
                                        @foreach($appointmentHistory->take(3) as $hist)
                                            <a href="{{ route('counselor.appointments.show', $hist->id) }}"
                                                class="list-group-item list-group-item-action">
                                                <div class="d-flex w-100 justify-content-between">
                                                    <small
                                                        class="fw-bold text-dark">{{ \Carbon\Carbon::parse($hist->scheduled_at)->format('M d, Y') }}</small>
                                                    <small
                                                        class="badge bg-secondary">{{ $hist->status === 'accepted' ? 'Approved' : ucfirst($hist->status) }}</small>
                                                </div>
