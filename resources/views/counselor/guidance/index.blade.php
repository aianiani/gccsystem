                            ...
                            <form method="GET" action="{{ route('counselor.guidance.index') }}"
                                ...
                                <div class="col-6 col-md-auto">
                                    <select name="year_level" class="form-select-custom w-100"
                                        ...
                                        <option value="5" {{ request('year_level') == '5' ? 'selected' : '' }}>5th Year
                                        </option>
                                        <option value="6" {{ request('year_level') == '6' ? 'selected' : '' }}>6th Year
                                        </option>
                                    </select>
                                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="student_ids[]" value="{{ $student->id }}"
                                                        ...
                                                        style="transform: scale(1.2); cursor: pointer;" {{ in_array($student->id, $selectedIds) ? 'checked' : '' }}>
                                                </td>
                                                <td>
                            ...
                            <div id="bulkToolbar">
                                ...
                                <div class="d-flex gap-1 align-items-center">
                                    <select name="seminar_name" class="form-select-custom form-select-sm py-0 ps-2 pe-4"
                                        ...
                                        @foreach($allSeminars as $sem)
                                            <option value="{{ $sem->name }}" {{ (session('guidance_target_seminar') == $sem->name || request('seminar_name') == $sem->name) ? 'selected' : '' }}>
                                                {{ $sem->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <input type="hidden" name="year_level" id="bulkYearLevel"
                                        value="{{ session('guidance_target_year', request('year_level')) }}">
                                ...
                                <div class="ms-1 border-start ps-2 d-flex align-items-center" style="height: 16px;">
                                    <a href="{{ route('counselor.guidance.clear_selection') }}"
