                    ...
                    <div class="card session-note-card">
                        <div class="session-note-header d-flex align-items-center gap-3">
                            ...
                            <div class="ms-auto text-end small text-muted">
                                <div><i class="bi bi-calendar me-1"></i>{{ $appointment->scheduled_at->format('F j, Y') }}
                                </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3 d-flex align-items-center justify-content-between">
                                            <label class="form-label mb-0 fw-semibold">Session # <span
                                                    class="badge bg-primary ms-2">{{ $nextSessionNumber }}</span></label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="note" id="note" class="form-control note-textarea" rows="8"
                                                maxlength="4000"
                                                placeholder="Write the session note here...">{{ old('note') }}</textarea>
                                            ...
                                            <div class="d-flex justify-content-between mt-1">
                                                ...
                                                <div class="char-counter" id="charCounter">{{ strlen(old('note') ?? '') }} /
                                                    4000</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" name="next_session" id="next_session"
                                                class="form-control" value="{{ old('next_session') }}">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="border rounded p-3 h-100">
                                            ...
                                            <div>
                                                ...
                                                <div class="fw-medium">{{ $appointment->student->contact_number ?? 'N/A' }}
                                                </div>
                                            </div>
                                            <div class="mt-2">
                                                <div class="small text-muted">College / Course</div>
                                                <div class="fw-medium">{{ $appointment->student->college ?? 'N/A' }} •
                                                    {{ $appointment->student->course ?? 'N/A' }}</div>
                                            </div>
                                            <div class="mt-3">
