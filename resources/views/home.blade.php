...
<body>
    ...
    @if(session('registration_success_message'))
        <script>         document.addEventListener('DOMContentLoaded', function () { if (window.Swal) { Swal.fire({ icon: 'success', title: 'Registration Successful!', html: '{{ session('registration_success_message') }}', confirmButtonText: 'OK, got it', allowOutsideClick: false }); } else { alert('{{ session('registration_success_message') }}'); } });
        </script>
    @endif
    <!-- Daily Quote Script -->
    <script>
