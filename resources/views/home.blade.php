...
<head>
    ...
    <style>
        * {
        ...
        .counselor-card .card-body { padding: 1.5rem 1.5rem 1.25rem; }
        ...
        .specialization { background: transparent; padding: 0; border-radius: 0; margin-bottom: .75rem; border-left: none; }
        .specialization strong { color: var(--text-dark); margin-right: .25rem; }
        .spec-links { color: var(--accent-green); text-decoration: underline; text-decoration-thickness: 1px; text-underline-offset: 3px; }
        
        .specialization strong {
            color: var(--primary-green);
        }

        .availability { background: transparent; padding-top: .75rem; border-radius: 0; border: 0; border-top: 1px solid rgba(0,0,0,0.08); }
        .availability strong { display:block; margin-bottom:.35rem; }
        ...
        .counselor-image .shine {
            position: absolute; inset: 0; background: radial-gradient(120% 60% at -10% -30%, rgba(255,255,255,.35) 0%, rgba(255,255,255,0) 60%);
        }
        .counselor-meta { display:flex; gap:1rem; flex-wrap:wrap; margin-bottom:.75rem; color: var(--text-light); font-size:.9rem; }
        .counselor-meta i { color: var(--accent-green); }
        .counselor-actions { display:flex; gap:.5rem; margin-top: 1rem; }
        .btn-counselor-primary { background: var(--primary-green); color:#fff; border:none; border-radius:10px; padding:.55rem .9rem; font-weight:600; box-shadow: 0 6px 16px rgba(34,139,34,0.18); }
        .btn-counselor-primary:hover { filter: brightness(.95); }
        .btn-counselor-ghost { background: #fff; color: var(--primary-green); border:1px solid rgba(34,139,34,.25); border-radius:10px; padding:.55rem .9rem; font-weight:600; }
        .btn-counselor-ghost:hover { background: var(--light-green); }
        ...
        #home, #counselors, #services, #contact { scroll-margin-top: 90px; }
    </style>
</head>
<body>
    <div class="home-zoom">
    ...
    <section id="announcements" class="py-5" style="background: var(--bg-light);">
        <div class="container">
                            ...
                            <div class="announcement-card-horizontal">
                                <div class="announcement-content">
                                    ...
                                    <div class="announcement-body">
                                        ...
                                        <p class="announcement-excerpt">{{ \Illuminate\Support\Str::limit(strip_tags($announcement->content ?? $announcement->body ?? ''), 200) }}</p>
                                        <a href="{{ route('announcements.show', $announcement) }}" class="announcement-action" aria-label="Read more about {{ $announcement->title }}">
                            ...
                            <div class="announcement-card-horizontal">
                                <div class="announcement-content">
                                    ...
                                    <div class="announcement-body text-center">
                                        ...
                                        <p class="announcement-excerpt">Please check back later for updates and center news.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="announcement-controls-external d-flex justify-content-center align-items-center mt-4">
                <button type="button" class="announcement-nav announcement-prev" id="announcementPrev" aria-label="Previous announcement">
                ...
                <button type="button" class="announcement-nav announcement-next" id="announcementNext" aria-label="Next announcement">
            ...
            <div class="text-center mt-4">
                <small class="text-muted">Debug: {{ $announcements ? count($announcements) : 'No announcements variable' }} announcements found</small>
                <br>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="counselor-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted">Dr. Wilson focuses on helping students build healthy relationships and develop strong self‑confidence.</p>
                            <div class="availability">
    ...
    <section class="testimonials py-5" style="background: white;">
        <div class="container">
            ...
            <div class="testimonials-carousel position-relative">
                    ...
                    <div class="testimonials-track d-flex" id="testimonialsTrack">
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                <p class="testimonial-text">"The counseling services at CMU helped me manage my anxiety before exams. Dr. Smith provided practical techniques that I still use today."</p>
                                <div class="testimonial-author">Jamie C. <span class="testimonial-role">- Computer Science, Senior</span></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                <p class="testimonial-text">"When I was struggling with career decisions, Prof. Doe helped me identify my strengths and explore options I hadn't considered before."</p>
                                <div class="testimonial-author">Alex M. <span class="testimonial-role">- Business Administration, Junior</span></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                <p class="testimonial-text">"The chat support was there for me during a late‑night study session when I was overwhelmed. Just having someone to talk to made all the difference."</p>
                                <div class="testimonial-author">Taylor W. <span class="testimonial-role">- Engineering, Sophomore</span></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                <p class="testimonial-text">"I was dealing with family issues that affected my studies. The counseling center provided a safe space to process my emotions and develop coping strategies."</p>
                                <div class="testimonial-author">Maria S. <span class="testimonial-role">- Nursing, Graduate</span></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                ...
                                <div class="testimonial-author">David L. <span class="testimonial-role">- Psychology, Senior</span></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                ...
                                <div class="testimonial-author">Ahmed K. <span class="testimonial-role">- Information Technology, Junior</span></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                ...
                                <div class="testimonial-author">Sarah P. <span class="testimonial-role">- Education, Sophomore</span></div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial-slide flex-shrink-0" style="width: 100%;">
                            <div class="testimonial-card">
                                <p class="testimonial-text">"The career counseling helped me discover my passion for research. I'm now pursuing a master's degree and working as a research assistant."</p>
                                <div class="testimonial-author">Michael R. <span class="testimonial-role">- Biology, Graduate</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Navigation Arrows -->
                <button type="button" class="testimonial-nav testimonial-prev" id="testimonialPrev" aria-label="Previous testimonials">
                    <i class="fas fa-chevron-left"></i>
                </button>
                <button type="button" class="testimonial-nav testimonial-next" id="testimonialNext" aria-label="Next testimonials">
                    <i class="fas fa-chevron-right"></i>
                </button>
    ...
    <style>
        ...
        #loginModal .btn-auth-primary:hover, #forgotPasswordModal .btn-auth-primary:hover, #twoFactorModal .btn-auth-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 8px 25px rgba(15, 94, 29, 0.35), 0 2px 8px rgba(0,0,0,0.15);
            filter: brightness(1.08);
        }
        ...
        #signupStep1 .mb-3, #signupStep2 .mb-3, #signupStep3 .mb-3, #signupStep4 .mb-3 {
        ...
        #signupStep1 h6, #signupStep2 h6, #signupStep3 h6, #signupStep4 h6 {
            margin-bottom: 0.75rem !important;
            font-size: 0.95rem;
        }
                                ...
                                <form id="modalLoginForm" method="POST" action="{{ url('/login') }}">
                                    ...
                                    <div class="mb-3">
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" class="form-control" required autocomplete="email" placeholder="Email Address">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <div class="input-group">
                                ...
                                <form method="POST" action="{{ url('/register') }}" enctype="multipart/form-data" id="signupForm">
                                    ...
                                    <div id="signupStep1">
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                                <input type="text" name="middle_name" class="form-control" placeholder="Middle Name (Optional)" autocomplete="additional-name">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <div class="input-group">
                                        ...
                                        <div class="mb-3" id="genderOtherField" style="display: none;">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="gender_other" class="form-control" placeholder="Please specify your gender" id="genderOtherInput" value="{{ old('gender_other') }}">
                                            </div>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    ...
                                    <div id="signupStep2" class="d-none">
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group">
                                                ...
                                                <input type="tel" name="contact_number" class="form-control" required placeholder="Contact Number * (e.g., 09XXXXXXXXX)" pattern="[0-9]{10,11}" autocomplete="tel">
                                            </div>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                        <div class="mb-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="address" class="form-control" required placeholder="Home Address * (House/Street, Barangay, City/Province)" autocomplete="address-line1">
                                            </div>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                        <div class="step-navigation">
                                    ...
                                    <div id="signupStep3" class="d-none">
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                                <input type="password" name="password" class="form-control" required autocomplete="new-password" placeholder="Password * (min 8 characters)" id="signupPassword">
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                                <input type="password" name="password_confirmation" class="form-control" required autocomplete="new-password" placeholder="Confirm Password *" id="signupPasswordConfirm">
                                    ...
                                    <div id="signupStep4" class="d-none">
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="student_id" class="form-control" required placeholder="Student ID * (e.g., 2021-12345)">
                                            </div>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                        <div class="row g-2">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">
                                                <div class="alert alert-info d-flex align-items-center mt-2" style="background: linear-gradient(135deg, #e3f2fd 0%, #f3e5f5 100%); border: 1px solid #2196f3; border-radius: 8px;">
                                                    <i class="fas fa-info-circle me-2" style="color: #2196f3;"></i>
                                                    <div>
                                                        <strong>Certificate of Registration (COR) Required</strong><br>
                                                        <small class="text-muted">Upload your COR in PDF, JPG, or PNG format (Max 5MB). This will be used for verification by the counselor.</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="invalid-feedback"></div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3 small">
                            ...
                            <div class="d-flex align-items-center">
                                <form method="POST" action="{{ route('2fa.resend') }}" id="resend2faForm">
                                    @csrf
                                    <button type="submit" class="btn btn-link p-0 tiny-link" id="resend2faBtn">Resend code</button>
                                </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (loginForm) {
                loginForm.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        // Handle successful JSON login (redirect info provided)
            ...
            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', initializeEnhancedSignup);
            } else {
