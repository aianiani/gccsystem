    ...
    <div class="main-dashboard-inner home-zoom">
        ...
        <div class="page-header">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('users.create') }}" class="btn btn-dark btn-sm fw-semibold shadow-sm">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 mt-2">
                        <button type="button" class="btn btn-link text-decoration-none small fw-bold text-success p-0"
                            ...
                            aria-expanded="{{ request()->anyFilled(['year_level', 'sex', 'date_from', 'date_to']) ? 'true' : 'false' }}"
                            aria-controls="advancedFilters">
                            <i class="bi bi-sliders me-1"></i> More Filters (Year, Sex, Dates)
                        </button>
                        @if(request()->anyFilled(['year_level', 'sex', 'date_from', 'date_to']))
