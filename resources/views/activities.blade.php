                                        ...
                                        <div class="d-flex align-items-center">
                                            @if($activity->user)
                                                <div class="d-inline-flex align-items-center justify-content-center bg-primary bg-opacity-10 rounded-circle me-3 shadow" style="width: 45px; height: 45px;">
                                                    <img src="{{ $activity->user->avatar_url }}" alt="Avatar" class="rounded-circle" width="36" height="36">
                                                </div>
                                            @else
                                                <div class="d-inline-flex align-items-center justify-content-center bg-secondary bg-opacity-10 rounded-circle me-3 shadow" style="width: 45px; height: 45px;">
