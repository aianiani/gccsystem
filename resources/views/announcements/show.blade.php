            ...
            <div class="py-4 px-4 px-lg-5 mb-4 rounded-4 announcement-header-bg"
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div>
                        ...
                        <h1 class="h3 fw-bold mb-2 announcement-title">{{ $announcement->title }}</h1>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4 p-lg-5 announcement-content-card">
                            ...
                            @if($attachmentPath)
                                @if($isImage)
                                    <div class="rounded-3 overflow-hidden mb-3 d-flex justify-content-center bg-light"
                                        ...
                                        <a href="{{ $attachmentUrl }}" target="_blank" class="d-inline-block position-relative">
                                            <img src="{{ $attachmentUrl }}" alt="Announcement Attachment" class="img-fluid"
                            ...
                            @if($announcement->images && count($announcement->images) > 0)
                                ...
                                <script>
                                    const galleryImages = @json($announcement->images ? collect($announcement->images)->map(fn($img) => asset('storage/' . $img)) : []);
