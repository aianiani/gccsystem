        ...
        @foreach($students as $student)
                    <div class="student-card">
                        ...
                        <div class="student-body">
                            ...
                            <div class="student-stats">
                                <div class="stat-item">
                                    <div class="stat-number">
                                        @php
                                            $completedSessions = \App\Models\Appointment::where('student_id', $student->id)
                                ...
                                <div class="stat-item">
                                    <div class="stat-number">
                                        @php
                                            $assessments = \App\Models\Assessment::where('user_id', $student->id)->count();
                                        @endphp
                                        {{ $assessments }}
                                    </div>
                            ...
                            <a href="{{ route('chat.index', $student->id) }}" class="chat-btn">
