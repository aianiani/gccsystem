                            ...
                            @if($students->count() > 0)
                                <div class="inbox-list">
                                    @foreach($students as $student)
                                        <a href="{{ route('chat.index', $student->id) }}" class="inbox-item">
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                                        <h6 class="mb-0 font-weight-bold text-dark">{{ $student->name }}</h6>
                                                        @if($student->last_message)
                                                            <small class="text-muted" style="font-size: 0.75rem;">
                                                                {{ $student->last_message->created_at->diffForHumans(null, true, true) }}
                                                            </small>
                                                        @endif
                                                    </div>
                                                    <p class="mb-0 text-muted small text-truncate" style="max-width: 250px;">
                                                        @if($student->last_message)
                                                            ...
                                                            @endif
                                                            {{ $student->last_message->content ?: ($student->last_message->image ? 'Sent an image' : '') }}
                                                        @else
                                                            {{ $student->email }}
                                                        @endif
                                                    </p>
