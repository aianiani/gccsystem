                                                ...
                                                @for($i = 0; $i <= 3; $i++)
                                                    <div class="col-12 col-md-6 col-lg-3">
                                                        <div class="form-check dass42-option-check w-100" data-value="{{ $i }}">
                                                            <input class="form-check-input" type="radio" name="answers[{{ $idx }}]"
                                                                id="q{{ $idx }}_{{ $i }}" value="{{ $i }}" required tabindex="-1">
                                                            <label class="form-check-label w-100" for="q{{ $idx }}_{{ $i }}"
