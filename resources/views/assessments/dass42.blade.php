...
@section('content')
    <style>
        ...
        .dass42-options-row {
            ...
            flex-wrap: wrap;
            gap: 0.5rem;
            align-items: flex-end; /* Aligns boxes to bottom baseline */
}

        .dass42-options-row > div {
            flex: 1 1 calc(25% - 0.5rem); /* 4 columns on desktop */
            min-width: 200px; /* Stack on mobile */
}
        ...
        .dass42-option-check {
            ...
            display: flex;
            align-items: center;
            min-height: 60px; /* Single consistent height */
        ...
        */
        ...
        .dass42-option-check.selected[data-value="0"] { transform: scale(1.01); }
        .dass42-option-check.selected[data-value="1"] { transform: scale(1.02); }
        .dass42-option-check.selected[data-value="2"] { transform: scale(1.035); }
        .dass42-option-check.selected[data-value="3"] { transform: scale(1.05); }
        ...
        .dass42-review-question { flex: 1 1 auto; color: #2d5016; font-size: 1rem; line-height: 1.4; word-break: break-word; }
        .dass42-review-answer { flex: 0 0 auto; padding-top: 0.2rem; }
        .dass42-review-answer .badge { font-size: 1rem; min-width: 160px; max-width: 200px; padding: 0.5rem 1rem !important; text-align: center; background: #2d9a36; color: #fff; border: none; white-space: normal; word-break: break-word; }

        @media (max-width: 768px) {
            .dass42-review-item { flex-direction: column; align-items: stretch; gap: 0.75rem; }
            .dass42-review-answer { flex: 0 0 auto; padding-top: 0; }
            .dass42-review-answer .badge { width: 100%; min-width: auto; max-width: none; }
        }
        ...
        @media (max-width: 600px) {
            ...
            .dass42-nav-controls { padding: 0.75rem 0.5rem !important; flex-wrap: wrap; }
            .das42-nav-controls button { font-size: 0.9rem; padding: 0.6rem 1rem; }
            .assessment-header { font-size: 1.3rem; }
        }
    </style>
            ...
            <div class="main-dashboard-inner">
                <div class="container py-1">
                    ...
                    <div class="assessment-subtitle">
                        Depression, Anxiety, and Stress Scale — Please take your time to answer all 42 questions honestly.
                    </div>

                    <div class="info-banner" role="status" aria-live="polite">
                        Quick heads-up: You’ll answer 42 quick questions in about 5–10 minutes. Your responses are private and help us understand how to support you. You can pause and return anytime.
                    </div>

                    <!-- DASS-42 Assessment Form -->
                    <form method="POST" action="{{ route('assessments.dass42.submit') }}" class="dass42-form">
                        @csrf
                        ...
                        <div id="dass42-question-wrapper" class="dass42-question-wrapper">
                            <ol class="dass42-questions-list">
                                @foreach($dass42_questions as $idx => $question)
                                    <li class="dass42-question-item" data-question="{{ $idx }}">
                                        <div class="fw-bold mb-2">{{ ($idx+1) . ". " . $question }}</div>
                                        <div class="row g-2 align-items-center dass42-options-row">
                                            @for($i=0; $i<=3; $i++)
                                                <div class="col-12 col-md-6 col-lg-3">
                                                                   <div class="form-check dass42-option-check w-100" data-value="{{ $i }}">
                        ...
                        <div class="dass42-nav-controls">
                            <button type="button" class="btn btn-outline-secondary" id="dass42-prev" style="visibility:hidden;">Previous</button>
                            ...
                            <div class="dass42-review-list mb-3">
                                    @foreach($dass42_questions as $idx => $question)
                                        <div class="dass42-review-item">
                                            <div class="dass42-review-question"><span class="fw-semibold">{{ ($idx+1) . ". " . $question }}</span></div>
                                            <div class="dass42-review-answer">
                                                <span class="badge dass42-summary-answer px-3 py-2" data-summary="{{ $idx }}">Not answered</span>
                                            </div>
                                        </div>
                                    @endforeach
                            </div>
