<div class="custom-sidebar">
    <div class="sidebar-logo mb-4 text-center">
        <img src="{{ asset('images/logo.jpg') }}" alt="CMU Logo"
            style="width:60px;height:60px;border-radius:50%;display:block;margin:0 auto 0.5rem;">
        <h3 style="margin:0.25rem 0 0; font-size:1.25rem; font-weight:700; color: var(--yellow-maize, #f4d03f);">CMU
            Guidance</h3>
    ...
    <nav class="sidebar-nav flex-grow-1">
        ...
        <a href="{{ route('appointments.index') }}"
            class="sidebar-link{{ request()->routeIs('appointments.index') ? ' active' : '' }}"><i
        ...
        <div class="sidebar-resources px-2">
            <div class="text-uppercase small text-muted mb-2" style="color: rgba(255,255,255,0.75); font-weight:600;">
                Resources</div>
