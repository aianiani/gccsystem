                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->college ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Course</label>
                                            <input type="text" class="form-control" value="{{ $student->course ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Year Level</label>
                                            <input type="text" class="form-control"
                                                value="{{ $student->year_level ?? 'N/A' }}" readonly>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ $student->address ?? 'N/A' }}"
                                                readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Contact Number</label>
                                            <input type="text" class="form-control"
                                                value="{{ $student->contact_number ?? 'N/A' }}" readonly>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        @foreach($counselors as $counselor)
                                            <div class="counselor-card" data-counselor-id="{{ $counselor->id }}">
                                                <div class="counselor-avatar">
                                                    <img src="{{ $counselor->avatar_url ?? 'https://via.placeholder.com/80x80/228B22/FFFFFF?text=' . substr($counselor->name, 0, 2) }}"
                                                        alt="{{ $counselor->name }}">
                                                </div>
