                                        ...
                                        <div class="appointment-card {{ $statusClass }}">
                                            ...
                                            <div class="card-body-styled">
                                                <div class="time-badge">
                                                    ...
                                                    {{ $start->format('M d, Y') }} • {{ $start->format('g:i A') }} - {{ $start->copy()->addHour()->format('g:i A') }}
                                                </div>
                                                        ...
                                                        <div class="mb-3">
                                                            @if($appointment->reschedule_reason)
                                                                <div class="reschedule-reason-box p-2 mb-2 rounded bg-info bg-opacity-10 border border-info border-opacity-25">
                                                                    ...
                                                                    <p class="mb-0 small text-dark" style="word-break: break-word;">{{ $appointment->reschedule_reason }}</p>
                                                                </div>
                                                            @endif
                                                            <small class="text-info fw-bold d-block mb-2">New time proposed: {{ $appointment->scheduled_at->format('M d, Y • g:i A') }}</small>
                                                            <div class="d-flex gap-2">
                                                                <form
