                                        ...
                                        <div class="appointment-card">
                                            <div class="appointment-header d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    @endif
                                                    <div>
                                                        <h6 class="mb-0 fw-bold">{{ $appointment->counselor->name ?? 'Counselor' }}
                                                        </h6>
                                            ...
                                            <div class="appointment-body">
                                                <div class="row mb-4">
                                                    <div class="col-md-6 mb-2">
                                                        <div class="d-flex align-items-center text-muted">
                                                            ...
                                                            <span
                                                                class="fw-medium text-dark">{{ $appointment->scheduled_at->format('F j, Y') }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <div class="d-flex align-items-center text-muted">
                                                            <i class="bi bi-clock me-2"></i>
                                                            <span>{{ $appointment->scheduled_at->format('g:i A') }} -
                                                                {{ $appointment->scheduled_at->addMinutes(30)->format('g:i A') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="session-note">
                                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                                            <h6 class="fw-bold text-success mb-0">
                                                                ...
                                                                {{ $completedAppointments->count() - $loop->parent->index }}
                                                            </h6>
                                                            <small
                                                                class="text-muted">{{ $sessionNote->created_at->format('M j, g:i A') }}</small>
                                                        </div>
                                                ...
                                                <div class="feedback-section">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            @if($existingFeedback)
                                                                <div class="d-flex align-items-center gap-2 mt-2">
                                                                    <div class="d-flex">
                                                                        @for($i = 1; $i <= 5; $i++)
                                                                            <i
                                                                                class="bi bi-star{{ $i <= $existingFeedback->rating ? '-fill' : '' }} text-warning"></i>
                                                                        @endfor
                                                                    </div>
                                                                    <span
                                                                        class="text-muted small">({{ $existingFeedback->rating }}/5)</span>
                                                                </div>
                                                                <p class="mb-0 text-muted small mt-1">
                                                                    {{ Str::limit($existingFeedback->comments, 100) }}</p>
                                                            @else
                                                        ...
                                                        @if(!$existingFeedback)
                                                            <a href="{{ route('session-feedback.create', $appointment->id) }}"
