...
<body>
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr>
                <td>Date & Time:</td>
                <td>{{ $appointment->scheduled_at->format('F d, Y h:i A') }}</td>
            </tr>
            <tr>
                <td>Counselor:</td>
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr>
                <td>Category:</td>
                <td>{{ $appointment->nature_of_problem }}</td>
            </tr>
            @if($appointment->nature_of_problem === 'Other' && $appointment->nature_of_problem_other)
            <tr>
                <td>Details:</td>
                <td>{{ $appointment->nature_of_problem_other }}</td>
            </tr>
            @endif
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr>
                ...
                <td>{{ $appointment->guardian1_name }}</td>
            </tr>
            <tr>
                <td>Guardian 1 Relationship:</td>
                <td>{{ $appointment->guardian1_relationship }}</td>
            </tr>
            <tr>
                <td>Guardian 1 Contact:</td>
                <td>{{ $appointment->guardian1_contact }}</td>
            </tr>
            @if($appointment->guardian2_name)
            <tr>
                <td>Guardian 2 Name:</td>
                <td>{{ $appointment->guardian2_name }}</td>
            </tr>
            <tr>
                <td>Guardian 2 Relationship:</td>
                <td>{{ $appointment->guardian2_relationship }}</td>
            </tr>
            <tr>
                <td>Guardian 2 Contact:</td>
                <td>{{ $appointment->guardian2_contact }}</td>
            </tr>
            @endif
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table class="info-table">
            ...
            <tr>
                <td>College:</td>
                <td>{{ $appointment->student->college ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td>Course:</td>
                <td>{{ $appointment->student->course ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td>Year Level:</td>
                <td>{{ $appointment->student->year_level ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td>Sex:</td>
                <td>{{ ucfirst($appointment->student->gender ?? 'N/A') }}</td>
            </tr>
            <tr>
                <td>Address:</td>
                <td>{{ $appointment->student->address ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td>Contact Number:</td>
                <td>{{ $appointment->student->contact_number ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td>Email Address:</td>
    ...
    <div class="section">
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td>{{ $dass42Assessment->created_at->format('F d, Y') }}</td>
            </tr>
            @endif
        </table>
